...
if(!$edit)
{
 ...
 $user_button=tep_draw_submit_button_field('','Agregar usuario','class="btn btn-primary"');
}
else
{
 ...
 $user_button=tep_draw_submit_button_field('','Actualizar','class="btn btn-primary"');
}
...
if($action1=='change_password')
{
 ...
 'button'=>tep_draw_submit_button_field('','Confirmar','class="btn btn-primary"'),//tep_image_submit(PATH_TO_BUTTON.'button_confirm.gif', IMAGE_CONFIRM),
