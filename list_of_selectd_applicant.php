 ...
 if(!tep_not_null($action1) ||$action1=='excel_report' )
 {
  ...
  if($action1=='excel_report')
  {
   if(tep_not_null($_POST['ch_applicant_id'][0]))
   {
    ...
    include_once('class/' . 'mysql_to_excel.php');
  ...
  if($x > 0 && $x1 > 0)
  {
   ...
   while ($application = tep_db_fetch_array($result)) 
   {
    ...
    //  $applicant_join_status=tep_image(PATH_TO_IMAGE.'applicant_join.gif',INFO_TEXT_CANDIDATE_JOIN); 
     $applicant_join_status='<span class="badge badge-success"><i class="fa fa-thumbs-up" aria-hidden="true"></i> Joined</span>'; 
    }
    ...
    //  $applicant_join_status=tep_image(PATH_TO_IMAGE.'icon_declined.gif',INFO_TEXT_CANDIDATE_DECLINED); 
     $applicant_join_status='<span class="badge badge-danger"><i class="fa fa-thumbs-down" aria-hidden="true"></i> Declined</span>'; 
    }
...
if (is_object($aInfo)) 
{
 $heading[] = array('params'=>'background="img/emp_left_bar_bg.gif"','text' => '<div class="list-group"><div class="list-group-item list-group-item-action info-bg font-weight-bold">' . tep_db_output($aInfo->full_name) . '<div><small>'.TEXT_INFO_APPLICANT_OPRATION.'</div></small></div></div>');
//  $contents[] = array('align' => 'center', 'text' => TEXT_INFO_APPLICANT_OPRATION);
 $contents[] = array('align' => 'left','params'=>'class="dataTableRightRow"  onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"',  'text' => '<a class="list-group-item list-group-item-action px-3 py-2" href="#" onclick="set_action2(\''.$aInfo->application_id.'\',\'send_to_mail\')"   class="style27">'.INFO_TEXT_SEND_MAIL.'</a>');
 if($aInfo->applicant_join_status=='joined')
 {
  $contents[] = array('align' => 'left','params'=>'class="dataTableRightRow1"  onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"',  'text' => '<a class="list-group-item list-group-item-action px-3 py-2" href="#" onclick="set_action2(\''.$aInfo->application_id.'\',\'candidate_disjoin\')"   class="style27">'.INFO_TEXT_REMOVE_JOIN.'<span class="badge badge-danger float-right"><i class="fa fa-thumbs-down" aria-hidden="true"></i> Remove</span></a>');
 }
 elseif($aInfo->applicant_join_status=='declined')
 {
  $contents[] = array('align' => 'left','params'=>'class="dataTableRightRow1"  onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"',  'text' => '<a class="list-group-item list-group-item-action px-3 py-2" href="#" onclick="set_action2(\''.$aInfo->application_id.'\',\'remove_dicline\')"   class="style27">'.INFO_TEXT_REMOVE_DECLINED.'<span class="badge badge-danger float-right"><i class="fa fa-thumbs-down" aria-hidden="true"></i> Remove</span></a>');
 }
 else
 {
  $contents[] = array('align' => 'left','params'=>'class="dataTableRightRow1"  onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"',  'text' => '<a class="list-group-item list-group-item-action px-3 py-2" href="#" onclick="set_action2(\''.$aInfo->application_id.'\',\'candidate_join\')" ">'. INFO_TEXT_JOIN .' <span class="badge badge-success float-right"><i class="fa fa-thumbs-up" aria-hidden="true"></i> Joins</span></a> ');
  
  $contents[] = array('align' => 'left','params'=>'class="dataTableRightRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"',  'text' => '<a class="list-group-item list-group-item-action px-3 py-2" href="#" onclick="set_action2(\''.$aInfo->application_id.'\',\'candidate_decline\')" ">'.INFO_TEXT_DECLINED .'  <span class="badge badge-danger float-right"><i class="fa fa-thumbs-down" aria-hidden="true"></i> Declines</span></a> ');
 }
}
...
// HEADING_TITLE_JOINED
 $template->assign_vars(array(
  ...
  'INFO_TEXT_MESSAGE1'=> tep_draw_textarea_field('message1', 'soft', '80%', '10', $email_text, '', true, true,'class="form-control"'),
  ...
  <a href="'.tep_href_link(FILENAME_RECRUITER_LIST_OF_SELECTD_APPLICANT,"jobID=".$job_id."&".$page_string).'" class="btn btn-secondary btn-sm">'.IMAGE_CANCEL.'</a>',
...
elseif($action1=='preview')
{
 ...
 $template->assign_vars(array(
  ...
  'buttons'=>'<a href="#" onclick="javascript: set_action(\'back\');" class="btn btn-secondary">'.IMAGE_BACK.'</a>&nbsp;&nbsp;
 ...
 */
 $quick_action='<select class="form-control form-control-sm" name="quick_action"  onchange="select_action1();">
...
elseif($join_status1=='new')
 ...
 $template->assign_vars(array(
  'HEADING_TITLE'=>$heading_title,
  'INFO_TEXT_BACK'=>'<a class="btn btn-secondary btn-sm float-right" href="#" onclick="javascript:history.back();">'.INFO_TEXT_BACK.'</a>',
  ...
  'INFO_TEXT_JOIN_STATUS1'=>tep_draw_pull_down_menu('join_status', $join_status_array, $join_status1,'onchange="document.page.submit();" class="form-control form-control-sm"'),
  'new_button'=>'',
