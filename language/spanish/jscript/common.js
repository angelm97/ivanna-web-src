...
///////////// Only for this site ends ////////
   ...
   if(objFrm[i].type=='file' && objFrm[i].value!="")
   {
    ...
    {
     validformFile = /(.doc|.Doc|.DOc|.DoC|.dOc|.DOC|.pdf|.Pdf|.PDf|.PdF|.pDf|.PDF|.txt|.Txt|.TXt|.TxT|.tXt|.TXT|.gif|.Gif|.GIf|.GiF|.gIf|.GIF|.jpg|.Jpg|.JPg|.JpG|.jPg|.JPG|.png|.Png|.PNg|.PnG|.pNg|.PNG)$/;
