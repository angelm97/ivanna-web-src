...
///////////// Only for this site ends ////////
			...
			objFrm[i].type=='radio')
		{
			...
			if(objFrm[i].type=='password' && objFrm[i].value!='' && objFrm[i].value.length >5 && objFrm[i].value.length >15)
			{
			...
			if(objFrm.TR_password.value!="" && objFrm.TR_confirm_password.value!="" && ( objFrm.TR_confirm_password.value!=objFrm.TR_password.value))
   {
