...
**********************************************************/
 ...
 define('HEADING_TITLE', 'Lista de ferias de empleo');
////////////
define('TABLE_HEADING_TITLE', 'Título');
define('TABLE_HEADING_INSERTED', 'Fecha de inicio');
define('TABLE_HEADING_EXPIRED', 'Fecha final');
define('TABLE_HEADING_STATUS', 'Estado');
define('TABLE_HEADING_JOBS','Oportunidades laborales');
define('TABLE_HEADING_ACTION', 'Acción');
define('TEXT_INFO_APPLY_NOW','Solicitar');
define('STATUS_JOB_INACTIVE', 'Inactivo');
define('STATUS_JOB_INACTIVATE', '¿Desactivar?');
...
define('MESSAGE_MAIL_SEND','Mensaje enviado para aprobación. Una vez aprobado, puedes agregar trabajos a la feria de empleo.');
...
define('IMAGE_EDIT','Editar trabajo');
define('IMAGE_UPDATE','Actualizar');
define('IMAGE_DELETE','Eliminar oportundiad laboral');
define('IMAGE_CONFIRM','Confirmar eliminación');
define('IMAGE_PREVIEW','Vista previa del trabajo');
define('IMAGE_UPDATE','Actualizar');
...
define('IMAGE_SELECTED_APPLICATIONS','Solicitantes seleccionados');

define('ERROR_QUESTION','Tienes que completar la pregunta No. <b>%s</b> Primero.');
define('IMAGE_VIEW_JOB','Ver oportunidad laboral');
define('INFO_TEXT_QUESTION','Pregunta-');
define('INFO_TEXT_ACTIVE_JOBFAIRS','Ferias de empleo activas');
define('INFO_TEXT_EXPIRED_JOBFAIRS','Ferias de empleo caducadas');
define('INFO_TEXT_SPECIFY_VACANCY_PERIOD','Especifica el período de vacante ...');
