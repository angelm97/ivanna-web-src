...
define('TABLE_HEADING_INSERTED', 'Fecha de creación');
define('TABLE_HEADING_UPDATED', 'Fecha de actualización');
...
define('INFO_TEXT_VIEW', 'Ver');
define('INFO_TEXT_DUPLICATE', 'Duplicar');
