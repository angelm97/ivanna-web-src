...
define('HEADING_SECTION','Completa todas las secciones y envía tu solicitud.');
...
define('INFO_TEXT_RESUMES','Tu perfil: ');
...
define('INFO_TEXT_DEFALUT_COVER_LETTER',''.SITE_TITLE.'Me encantaría participar en el proceso de selección para la oportunidad laboral que postularon en Waojobs.com. Pueden ver mi hoja de vida.');
...
define('MESSAGE_SUCCESS_APPLED','¡Cada vez más cerca al trabajo de tus sueños! Aquí hay algunas otras oportunidades laborales cercanas que pueden interesarte.');

////
define('IMAGE_CONFIRM','¡Quiero aplicar!');
define('INFO_TEXT_CANDIDATE_RESPOND','El candidato ha respondido positivamente a');
define('INFO_TEXT_QUALIFICATION_QUESTIONS','Preguntas de calificación.');
define('INFO_TEXT_APPLICANT_TRACKING','Seguimiento a candidatos -');
define('INFO_TEXT_SCREENER','Pantallazo');
define('INFO_TEXT_QUESTION','Pregunta');
define('INFO_TEXT_ANSWER','Respuesta-');
define('INFO_TEXT_NOT_ADDED_YET','No agregado todavía.');
