<?
define('HEADING_TITLE','Seguimiento de candidatos');
...
define('TABLE_HEADING_APPL_PHOTO','Foto');
define('TABLE_HEADING_APPL_NAME','Nombre');
define('TABLE_HEADING_APPL_EMAIL','Correo electrónico');
define('TABLE_HEADING_APPL_JOB_TITLE','Vacante');
define('TABLE_HEADING_APPL_STATUS','Estado');
define('TABLE_HEADING_DATE_OF_APPLICATION','Fecha de aplicación');
define('TABLE_HEADING_APPL_ACTION','Acción');
define('TABLE_HEADING_APPL_EDIT_STATUS','Estado');
