...
**********************************************************/
define('HEADING_TITLE', 'Response From Admin');
define('HEADING_TITLE1','Reply to Admin');
...
define('HEADING_TO_EMAIL','To :');
define('INFO_TEXT_FROM_EMAIL','From :');
define('IMAGE_BACK', 'Back');
define('IMAGE_ATTACHMENT','Attachment');
define('MESSAGE_SUCCESS_SENT','Reply Successfully sent');
define('INFO_TEXT_VIEW_IN_TRASH','View in Trash');
define('INFO_TEXT_VIEW_IN_INBOX','View in Inbox');
define('INFO_TEXT_VIEW_ALL','all');
define('INFO_TEXT_VIEW_MARKED','Marked');
...
define('INFO_TEXT_WITH_SELECTED1','With selected:');
...
define('INFO_TEXT_PLEASE_CHECK_ONE','Please check atleast one checkbox.');
define('INFO_TRASH','Trash');
define('INFO_INBOX','Inbox');
?>