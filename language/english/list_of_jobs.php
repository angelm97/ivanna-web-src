...
define('TABLE_HEADING_EXPIRED', 'Expired');
...
define('INFO_TEXT_RESUME_WEIGHT','Resume Weight');
...
define('IMAGE_UPDATE','Update');
define('IMAGE_EDIT_JOB','Edit job');
define('IMAGE_DELETE_JOB','Delete job');
define('IMAGE_UNDELETE_JOB','Un-delete job');
define('IMAGE_READVERTISE','Re-advertise job');
define('IMAGE_APPLICATIONS','View Applications');
...
define('IMAGE_REPORT','View Reports');
define('IMAGE_SELECTED_APPLICATIONS','Selected Applicants');

define('ERROR_QUESTION','You have to fill-up Question no. <b>%s</b> first.');
define('IMAGE_VIEW_JOB','View Job');
