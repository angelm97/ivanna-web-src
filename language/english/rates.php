...
define('INFO_TEXT_QUOT1','Post your jobs and access resume - Instantly.');
define('INFO_TEXT_QUOT2','These packages will help you hire the right person, right away. Select the product you wish to buy:');
...
define('INFO_TEXT_SEARCH_QUALIFIED','Search qualified resumes through advanced search engine');
