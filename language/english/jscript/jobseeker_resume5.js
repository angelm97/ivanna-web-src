...
function ValidateForm(objFrm)
{
 ...
 for( var i =0; i< objFrm.length;i++)
 {
   if(objFrm[i].type=='file' && objFrm[i].value!="")
   {
    ...
    {
     validformFile = /(.doc|.Doc|.DOc|.DoC|.dOc|.DOC|.pdf|.Pdf|.PDf|.PdF|.pDf|.PDF|.txt|.Txt|.TXt|.TxT|.tXt|.TXT|.DOCX|.gif|.Gif|.GIf|.GiF|.gIf|.GIF|.jpg|.Jpg|.JPg|.JpG|.jPg|.JPG|.png|.Png|.PNg|.PnG|.pNg|.PNG)$/i;
    ...
    {
     validformFile = /(.gif|.Gif|.GIf|.GiF|.gIf|.GIF|.jpg|.Jpg|.JPg|.JpG|.jPg|.JPG|.png|.Png|.PNg|.PnG|.pNg|.PNG|.jfif)$/;
     if(!validformFile.test(objFrm[i].value))
     {
