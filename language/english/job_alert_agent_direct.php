...
define('INFO_TEXT_JOB_ALERT_EMAIL','Email Address: ');
define('ENTER_EMAIL_ADDRESS','Please Enter Proper Email Address');
...
define('MESSAGE_SUCCESS_INSERTED','Success: You Email Address is saved for Job Alerts.');
