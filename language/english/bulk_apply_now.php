...
define('MESSAGE_SUCCESS_APPLED','You are successfully applied.');
define('ERROR','Please complete Personal Information first.');
////
define('IMAGE_CONFIRM','Apply now');
define('INFO_TEXT_ANSWER','answer');
define('INFO_TEXT_THE_CANDIDATE_RESPOND','The candidate has respond positively to');
define('INFO_TEXT_QUALIFICATION_QUESTION','qualification questions.');
define('INFO_TEXT_VIEW_RESUME','View Resume');
define('INFO_TEXT_JOBSITE_APPLICATION','Applicant Tracking Jobsite application -');
