...
$host_array=array('localhost','www.waojobs.com','waojobs.com','127.0.0.1');
...
if(tep_not_null($_POST['TR_post_job_category']))
   {
    $allindustry = explode(",", $_POST['allindustry']);
    array_pop($allindustry);
    $allindustry = implode(",", $allindustry);
    $job_category=tep_db_prepare_input(implode(',',$_POST['TR_post_job_category']));
    $job_category= $allindustry;
