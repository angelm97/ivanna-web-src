...
$locat= LIST_TABLE(COUNTRIES_TABLE,TEXT_LANGUAGE."country_name","priority","name='country' class='form-control form-control-lg theme9-form-size'","All Locations","",DEFAULT_COUNTRY_ID);
...
$industry_sector= tep_draw_pull_down_menu('job_category[]', $cat_array, '', 'class="form-control form-control-lg theme9-form-size"');
$button= '<button type="submit" class="btn theme9-btn-warning btn-lg btn-block">Find</button>';
/********************************  SEARCH CODE ENDS********************************************* */
...
if(strtolower($_SERVER['PHP_SELF'])=="/".PATH_TO_MAIN.FILENAME_INDEX)
{
 define('HEADER_MIDDLE_HTML','
            ...
            <div class="container text-center">
                <div class="row">
				<div class="col-md-12 slider-txt">
