    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="'.tep_href_link(FILENAME_JOB_SEARCH).'" type="button">'.INFO_TEXT_MENU_JOBS.'</a>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link btn btn-sm btn-theme6 px-3" href="'.tep_href_link(FILENAME_LOGIN).'">'.INFO_TEXT_MENU_SIGNIN.'</a>').'                
                </li>
