...
{	$jobrec_profilemenu='
    ...
    <a class="nav-link theme4-nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">'.$photo.'</a>
...
if(COOKIE_ALERT_POPUP=='true')
	$cookie_alert_popup='
    <!-- /.container -->
<div class="alert-warning alert-dismissible fade text-center cookiealert" role="alert"><strong>Cookies: </strong> This website uses cookies to improve your experience. We will assume you\'re ok with this, but you can opt-out if you wish. <a href="'.tep_href_link(FILENAME_PRIVACY).'" target="_blank"> Learn more</a><button type="button" class="btn btn-secondary btn-sm acceptcookies" aria-label="Close">OK, I ACCEPT</button></div>
';
else
$cookie_alert_popup='';
///////////////////////////////////////////////////////////////////////////////////////////////////
...
<body>
'.$cookie_alert_popup.'
<nav class="navbar navbar-expand-lg navbar-light bg-light mb-3 p-0 theme4-home-banner-bg">
    <div class="container">
