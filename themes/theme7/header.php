...
'.$cookie_alert_popup.'
<nav class="navbar navbar-expand-lg navbar-dark theme7-bg-dark mb-3">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ml-auto text-center top-nav">
                <li class="nav-item">
                    <a class="nav-link" href="'.tep_href_link(FILENAME_JOB_SEARCH).'">
                    <img src="'.HOST_NAME.'themes/theme7/images/icon-jobs.png"><span class="theme7-break-line">'.INFO_TEXT_MENU_JOBS.'</span></a>
                </li>
                    
                <li class="nav-item">
                    <a class="nav-link" href="'.tep_href_link(FILENAME_JOBSEEKER_COMPANY_PROFILE).'">
                    <img src="'.HOST_NAME.'themes/theme7/images/icon-companies.png"><span class="theme7-break-line">'.INFO_TEXT_MENU_COMPANIES.'</span></a>
                </li>
                ...
                <li class="nav-item">
                    ...
                    '<a class="nav-link" href="'.tep_href_link(FILENAME_JOBSEEKER_LOGIN).'">').
                        '<img src="'.HOST_NAME.'themes/theme7/images/icon-jobseeker.png"><span class="theme7-break-line">'.INFO_TEXT_MENU_JOBSEEKER.'</span></a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="'.tep_href_link(FILENAME_JOBSEEKER_RATES).'">
                    <img src="'.HOST_NAME.'themes/theme7/images/icon-buy.png"><span class="theme7-break-line">'.INFO_TEXT_MENU_BUY_ONLINE.'</span></a>
                </li>
                ...
                <li class="nav-item">
                    ...
                    '<img src="'.HOST_NAME.'themes/theme7/images/icon-employer.png"><span class="theme7-break-line">'.INFO_TEXT_MENU_RECRUITER.'</span></a>
                </li>
