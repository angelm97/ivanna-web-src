...
///////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    <html lang="en">
        ...
        '.$cookie_alert_popup.'
            ...
            <nav class="navbar navbar-expand-lg navbar-light border-bottom bg-light mb-3">
			<div class="container">
                ...
                '.(check_login("jobseeker")?'':'
                    ...
                    <li class="nav-item active">
                        '.(check_login("jobseeker")?'
                            <a class="nav-link" href="'.tep_href_link(FILENAME_JOBSEEKER_RESUME1).'">
                                '.INFO_POST_RESUME.'
                            </a>':'
                            <a class="nav-link" href="'.tep_href_link(FILENAME_RECRUITER_POST_JOB).'">
                            '.INFO_POST_JOB.'
                            </a>').'
                    </li>
