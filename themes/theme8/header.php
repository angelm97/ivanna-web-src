...
<nav class="navbar navbar-expand-lg navbar-light bg-light mb-3 theme8-bg-light">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="'.tep_href_link(FILENAME_JOB_SEARCH).'" type="button" class="dropbtn">Jobs</a>
                </li>
