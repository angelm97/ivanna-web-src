<?
//body_load() function required for country-state dropdown
...
<link rel="stylesheet" type="text/css" href="'.tep_href_link("themes/theme6/css/half-slider.css").'">
...
<body>
'.$cookie_alert_popup.'
<nav class="navbar navbar-expand-md navbar-dark mb-3 navbar-theme" style="background: linear-gradient(to right,#C50786,#7026B9);color:#fff;">
			    <div class="container">
                <div class="punchline" href="#">No#1 career job portal</div>
                    ...
                    '.(check_login("jobseeker") || check_login("recruiter")?'':'
                        <li class="nav-item dropdown">
                            ...
                            '.(check_login("jobseeker")?'
                                ...
                                '<a class="dropdown-item" href="'.tep_href_link(FILENAME_JOBSEEKER_LOGIN).'">').'Job Seeker</a>
                            '.(check_login("recruiter")?'
                                <a class="dropdown-item" href="'.tep_href_link(FILENAME_RECRUITER_CONTROL_PANEL).'">':
                                '<a class="dropdown-item" href="'.tep_href_link(FILENAME_RECRUITER_LOGIN).'">').'Employer</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item" href="'.tep_href_link(FILENAME_JOBSEEKER_REGISTER1).'">Job Seeker</a>
                                <a class="dropdown-item" href="'.tep_href_link(FILENAME_RECRUITER_REGISTRATION).'">Employer</a>
                                </div>
                        </li>
                    ').'
                        <li class="nav-item"><a class="nav-link" href="'.tep_href_link(FILENAME_JOB_ALERT_AGENT).'">Job alerts</a></li>
                        <li class="nav-item"><a class="nav-link" href="'.tep_href_link(FILENAME_RECRUITER_RATES).'">Pricing</a></li>
                        <li class="nav-item"><a class="nav-link" href="'.tep_href_link(FILENAME_ARTICLE).'">Resources</a></li>
                        <li class="nav-item"><a class="nav-link" href="'.tep_href_link(FILENAME_CONTACT_US).'">Contact us</a></li>
                    '.$jobrec_profilemenu.'
                    </ul>
                </div>
				</div>
