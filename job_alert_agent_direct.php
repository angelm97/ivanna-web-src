...
'INFO_TEXT_JOB_ALERT_EMAIL'   => INFO_TEXT_JOB_ALERT_EMAIL,
  'INFO_TEXT_JOB_ALERT_EMAIL1'  => tep_draw_input_field('TREF_job_alert_email', $TREF_job_alert_email,'size="26" maxlength="32" class="form-control required inputlogin"',false),
  'INFO_TEXT_KEYWORD'      => INFO_TEXT_KEYWORD,
  'INFO_TEXT_KEYWORD1'     => tep_draw_input_field('keyword', $keyword,'size="40" class="form-control inputlogin"',false),
  'INFO_TEXT_KEYWORD_CRITERIA'=>INFO_TEXT_KEYWORD_CRITERIA,
  'INFO_TEXT_KEYWORD3'     => tep_draw_radio_field('word1', 'Yes', '', $word1,'id=radio_word1').' <label class="mr-2 ml-1 font22" for="radio_word1 ">'.INFO_TEXT_KEYWORD_WORD1.'</label>'.tep_draw_radio_field('word1', 'No', '', $word1,'id=radio_word2').' <label for="radio_word2 " class="font22">'.INFO_TEXT_KEYWORD_WORD2.'</label>',
		'INFO_TEXT_JOB_ALERT_CRITERIA' => INFO_TEXT_JOB_ALERT_CRITERIA,
  'INFO_TEXT_JOB_ALERT_CRITERIA1'=> tep_draw_radio_field('job_alert', 'daily', '', $job_alert,'id=radio_daily').'<label class="mr-2 ml-1 font22" for="radio_daily">'.INFO_TEXT_DAILY.'</label> '.tep_draw_radio_field('job_alert', 'weekly', '', $job_alert,'id=radio_weekly').'<label class="mr-2 ml-1 font22" for="radio_weekly">'.INFO_TEXT_WEEKLY.'</label> '.tep_draw_radio_field('job_alert', 'monthly', '', $job_alert,'id=radio_monthly').'<label class="ml-1 font22" for="radio_monthly">'.INFO_TEXT_MONTHLY.'</label> ',

  'INFO_TEXT_LOCATION'     => (($search_zip_code==2)?INFO_TEXT_ZIP_CODE:INFO_TEXT_LOCATION_NAME),
  'INFO_TEXT_LOCATION1'    => (($search_zip_code==2)?tep_draw_input_field('zip_code',$zip_code,'').''.zone_radius('radius',"","",$radius,true).tep_draw_hidden_field('location',''):tep_draw_input_field('location', $location,' class="form-control inputlogin" ',false)),
...
':''),
  ...
  'INFO_TEXT_COUNTRY1'     => LIST_TABLE(COUNTRIES_TABLE,TEXT_LANGUAGE."country_name","priority","name='country' class='form-control inputlogin' ","All countries","",$country),
  ...
  'INFO_TEXT_JOB_CATEGORY1'=> tep_draw_pull_down_menu('job_category[]', $cat_array, explode(",",$job_category1), ' class="form-control inputlogin"', false),
  'INFO_TEXT_EXPERIENCE'   => INFO_TEXT_EXPERIENCE,
  'INFO_TEXT_EXPERIENCE1'  => experience_drop_down('name="experience" class="form-control inputlogin" ', 'Any experience', '', $experience),
  'INFO_TEXT_JOB_POSTED'   => INFO_TEXT_JOB_POSTED,
  'INFO_TEXT_JOB_POSTED1'  => LIST_SET_DATA(JOB_POSTED_TABLE,"",TEXT_LANGUAGE.'type_name','value',"priority","name='job_post_day' class='form-control inputlogin' " ,INFO_TEXT_DEFAULT_JOB_POST_DAY,'',$job_post_day),
  'button'                 => '<button class="btn btn-primary buttonauto" type="submit">Crear alerta de oportunidad laboral</button>',
