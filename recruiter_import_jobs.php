...
$template->assign_vars(array(
 ...
 'INFO_TEXT_SAMPLE_FILE1'   => '<a class="text-primary" href="'.tep_href_link('jobs.csv').'" target="_blank">'.INFO_TEXT_CSV_FILE.'</a>, <a class="text-primary" href="'.tep_href_link('job_xml.xml').'" target="_blank">'.INFO_TEXT_XML.'</a>',
