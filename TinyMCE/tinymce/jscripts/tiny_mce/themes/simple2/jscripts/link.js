...
function init() {
	...
	document.getElementById('hrefbrowsercontainer').innerHTML = getBrowserHTML('hrefbrowser','href','file','theme_simple2_link');
	...
	addClassesToList('styleSelect', 'theme_simple2_link_styles');
...
function insertLink() {
	...
	tinyMCE.themes['simple2']._insertLink(href, target, title, dummy, style_class);
	tinyMCEPopup.close();
}
