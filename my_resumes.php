...
$template->assign_vars(array(
 ...
 'add_new'=>"<a class='btn btn-sm btn-primary' href='".tep_href_link(FILENAME_JOBSEEKER_RESUME1)."'><i class='fa fa-plus mr-1' aria-hidden='true'></i> ".INFO_TEXT_ADD_NEW_RESUME."</a>",
