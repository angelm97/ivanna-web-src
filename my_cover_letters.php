...
if($edit)
{
 ...
 $description=$row_check['cover_letter'];
	$add_save_button='<button class="btn btn-primary" type="submit">Actualizar</button>';
	$add_save_button.="&nbsp;<a href='".tep_href_link(FILENAME_JOBSEEKER_LIST_OF_COVER_LETTERS)."' type='button' class='btn btn-secondary mx-2'>Cancelar</a>";
...
{
	$add_save_button='<button class="btn btn-primary" type="submit">Guardar</button>';
	$add_save_button.="&nbsp;<a href='".tep_href_link(FILENAME_JOBSEEKER_LIST_OF_COVER_LETTERS)."' type='button' class='btn btn-secondary mx-2'>Cancelar</a>";
...
else
{
 ...
 $template->assign_vars(array(
  ...
  'add_new'=>"<a class='btn btn-primary' href='".tep_href_link(FILENAME_JOBSEEKER_LIST_OF_COVER_LETTERS, 'action=add_new')."' >".INFO_TEXT_ADD_COVER_LETTER."</a>",
  'hidden_fields'=>$hidden_fields,
  'INFO_TEXT_JSCRIPT_FILE'  => $jscript_file,
  'LEFT_BOX_WIDTH'=>LEFT_BOX_WIDTH1,
  'RIGHT_BOX_WIDTH'=>$RIGHT_BOX_WIDTH,
