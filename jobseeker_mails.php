...
if(isset($_GET['query_string2'])  && $_GET['query_string2']!='')
{
  ...
  'INFO_TEXT_BUTTON'  => '<a href="'.tep_href_link(FILENAME_JOBSEEKER_MAILS,"query_string1=".$query_string2).'">'.tep_draw_submit_button_field('back', IMAGE_BACK,'class="btn btn-secondary"').'</a>&nbsp;&nbsp;'.tep_draw_submit_button_field('','Enviar','class="btn btn-primary"'),
...
elseif($mail_id>0)
{
 ...
 tep_db_query("update ".APPLICANT_INTERACTION_TABLE." set user_see='Yes' where id='".$mail_id."'");
  ...
  'INFO_TEXT_BACK'=>'<a href="'.FILENAME_JOBSEEKER_MAILS.'"><button class="btn btn-primary" >Atras</button>',
