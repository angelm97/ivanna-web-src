...
$billing_address="<span class='style16'>".$order->customer['company']."</span><br>".
                 "<span class='style22'>".$order->customer['firstname'].' '.$order->customer['lastname']."</span><br>".
                 "<span class='style27'>".$order->customer['street_address']."<br>".
...
$template->assign_vars(array(
 ...
 'TABLE_HEADING_COMMENTS1'=>tep_draw_textarea_field('comments', 'soft', '40', '5'),
 ...
 'INFO_TEXT_AMOUNT_DUE'=>"<b>FINAL AMOUNT : </b>".$sym_left.$amount_due.$sym_rt,
 'button'=>tep_image_submit(PATH_TO_BUTTON.'button_confirm_and_paynow.gif', IMAGE_BUTTON_NEXT),
