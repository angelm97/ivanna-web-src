...
$template->assign_vars(array(
 ...
 'TREF_email_address'=>tep_draw_input_field('TREF_email_address',$recruiter_email_address, 'class="form-control mb-2" placeholder="Email address"'),
 ...
 'buttons'=>tep_button_submit('btn btn-primary btn-block mt-3','Confirm'),
