...
define('IMAGE_NEW','reply to thread');
define('INFO_TEXT_TITLE','Title:');
define('INFO_TEXT_DESCRIPTION','Description:');
define('MESSAGE_SUCCESS_INSERTED','Message successfully posted');

define('MESSAGE_INVALID_FORUM_ERROR','Invalid topics.');
