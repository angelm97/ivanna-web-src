...
//  'new_button'    => '<a href="'.FILENAME_TOPIC_DETAILS.'?action=new&topic_id='.$_GET['topic_id'].'">'.tep_image_button(PATH_TO_BUTTON.'reply_to_thread.gif',IMAGE_NEW).'</a>&nbsp;&nbsp;',
 ...
 'INFO_TEXT_HEADING_SEARCH' => '<a href="'.tep_href_link(PATH_TO_FORUM.FILENAME_FORUM_SEARCH).'"  class="btn btn-sm btn-primary">'.tep_db_output(INFO_TEXT_HEADING_SEARCH).'</a>',
