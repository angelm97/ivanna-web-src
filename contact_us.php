...
'google_captcha'=>$gogle_captcha,
 ...
 'INFO_TEXT_MESSAGE1'      =>tep_draw_textarea_field('TR_message', 'soft', '40%', '10', $email_text, 'class="form-control required"', true),
 ...
 'button'=>tep_button_submit('btn btn-primary','Enviar'),
