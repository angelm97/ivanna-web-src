...
elseif(strtolower($order['orders_status_name']=='processing'))
	$statusclass='class="text-info-custom"';
else
	$statusclass='';
/////////////////////////////////////////////////////////////////////////
    ...
    $template->assign_block_vars('orders', array( 'row_selected' => $row_selected,
     ...
     'inserted' => tep_date_short(tep_db_output($order['inserted'])),
     'last_updated' => tep_date_short(tep_db_output($order['orders_date_finished'])),
     ));
    $alternate++;
   }
  }
