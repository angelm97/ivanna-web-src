...
$result_log_query = tep_db_query($check_data);
$result_log = tep_db_fetch_array($result_log_query);
$answer = $result_log['replies'];

if (tep_db_num_rows($result_log_query) > 0) {
    echo $answer;
}else{
    echo "Lo siento no puedo responderte esa pregunta";
}
