...
'TABLE_HEADING_RESUME_DELETE'=>TABLE_HEADING_RESUME_DELETE,
 'count_rows'=>$db_jobfair_split->display_count($db_jobfair_query_numrows, MAX_DISPLAY_LIST_OF_JOBS, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_JOBS),
  ...
  'new_button'=>'',
 'INFO_TEXT_LIST_OF_APPLICATIONS'=>($direct_login=='Yes'?tep_draw_form('search_applicant',FILENAME_RECRUITER_SEARCH_APPLICANT,'','post').tep_draw_hidden_field('action1','search').'<button class="btn submitbutton text-right type="submit">'.INFO_TEXT_LIST_OF_APPLICATIONS.'</button></form>':''),
