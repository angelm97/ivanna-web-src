...
<div id="profiles">
<br>
 <p style="color:blue;font-family:roboto;font-size:30px"> El Perfil ya existe cambia de cuenta de LinkedIn o Cierra Sesion</p>
<br>
<br>
<br>

<p style="color:blue;font-family:roboto;font-size:30px"> Si no te redirige automaticamente  <a href="<?echo $url;?>">Haz Click Aqui</a></p>
</div>
</body>
</html>