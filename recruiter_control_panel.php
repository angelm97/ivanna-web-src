...
////	$bar_total  =200;
 ...
 $graph ='<div class="col-md-6">
			<h5 class="card-header">Resumen de Oportunidades</h5>
			...
			<td align="center"  class="small2"><b>Oportunidades</b></td>
			<td align="center"  class="small2">Oportunidades Vigentes</td>
			<td align="center"  class="small2">Total de Talentos</td>
			<td align="center"  class="small2">Seleccionados</td>
			</tr>
			</table>
		</div>';
  if($no_of_applicant>0)
   ...
   $graph .='
   <div class="col-md-6">
   <h5 class="card-header">Candidatos por Fase de Reclutamiento</h5>
		<table class="table-responsive" background="img/line1.gif" border="0"  width="95%" bgcolor="#ffffff"  cellspacing="0" cellpadding="3">
			...
			<tr bgcolor="#ffffff" class="small">
				<td align="center"  class="small2"><b>Total</b></td>
				<td align="center"  class="small2">Preselección</td>
				<td align="center"  class="small2">Entrevista</td>
				<td align="center"  class="small2">Telefónica</td>
				<td align="center"  class="small2">Puebas de Competencias</td>
				<td align="center"  class="small2">Seleccionados</td>
				<td align="center"  class="small2">Ingresados</td>
				<td align="center"  class="small2">Declinados</td>
			</tr>
		</table>';
		}
		$graph .='</div>';
...
if(tep_not_null($row_contact['recruiter_logo']) && is_file(PATH_TO_MAIN_PHYSICAL_LOGO.$row_contact['recruiter_logo']))
{
 ...
 $logo = ($row_contact['recruiter_logo']?tep_image(FILENAME_IMAGE.'?image_name='.PATH_TO_LOGO.$row_contact['recruiter_logo'].'&size=210','','','') : '');
 ...
 $logo='<td width="17%"><div class="dashboardlogo mini-profile-img mr-3">'.$logo.'</div></td>
    ';
}
else
{
 $logo='<td  bgcolor="#ffffff" height="19" valign="top" width="10%" align="center"><table>
 <tr bgcolor="#C0C0C0">
 	<td width="120" height="100" align="center" style="color:#ffffff; font:bold 14px;">'.INFO_TEXT_NO_LOGO.'</td>
 </tr>
 </table><a href="'.tep_href_link(FILENAME_RECRUITER_REGISTRATION).'" class="blue">'.INFO_TEXT_ADD_LOGO.'</a></td>
     <td width="2%"><img src="img/dot.gif" height="10" width="10"></td>';
}
...
// 'INFO_TEXT_FAX'           => INFO_TEXT_FAX,
 ...
 'INFO_TEXT_POST_JOB'        => '<a href="'.tep_href_link(FILENAME_RECRUITER_POST_JOB).'" title="'.INFO_TEXT_POST_JOB.'" class="style39 customClass">'.INFO_TEXT_POST_JOB.'</a>',
 'INFO_TEXT_POST_JOB2'        => '<a href="'.tep_href_link(FILENAME_RECRUITER_POST_JOB).'" title="'.INFO_TEXT_POST_JOB.'" class="style39">'.INFO_TEXT_POST_JOB.'</a>',
 ...
 'INFO_TEXT_MY_ACTIVE_JOBS'  => '<a href="'.tep_href_link(FILENAME_RECRUITER_LIST_OF_JOBS).'" title="'.INFO_TEXT_LIST_OF_JOBS.'" class="style39">'.INFO_TEXT_MY_ACTIVE_JOBS.'</a> '.(($no_of_active_job>0)?'('.$no_of_active_job.')':''),
...
'INFO_TEXT_DIRECT_LOGIN'=>tep_draw_form('recstatus', FILENAME_RECRUITER_CONTROL_PANEL, '', 'post', '').($direct_login=='Yes'?tep_draw_hidden_field('action','direct_login_inactive'):tep_draw_hidden_field('action','direct_login_active')).'
...
</i> '.INFO_TEXT_APPLY_WITHOUT_LOGIN.' <label for="checkbox_rec_dr_log" class="switch">'.tep_draw_checkbox_field('direct_login','Yes','',$direct_login,' class="inputdemo" id="checkbox_rec_dr_log" onchange="this.form.submit();"').'<span class="slider round"></span></label></form>',
 ...
 'INFO_TEXT_EDIT_PROFILE'=>'<a href="'.tep_href_link(FILENAME_RECRUITER_REGISTRATION).'" title="'.INFO_TEXT_EDIT_PROFILE.'" class="style39">'.INFO_TEXT_EDIT_PROFILE.'</a>',
...
'RATE_CARD'=>'<a href="'.tep_href_link(FILENAME_RECRUITER_RATES).'">
 ...
 'INFO_TEXT_APPLICANT_TRACKING'=>tep_draw_form('applicant_tracking',FILENAME_RECRUITER_APPLICANT_TRACKING,'','post').tep_draw_hidden_field('action1','search').'<i class="fa fa-angle-right icon-page-title" aria-hidden="true"></i><button class="btn submitbutton" type="submit">'.INFO_TEXT_APPLICANT_TRACKING.'</button> ('.$no_of_applicant.')</form>'.(($no_of_applicant>0)?'':''),

 'INFO_TEXT_LIST_OF_UNREGISTERED_RESUMES'=> ($direct_login=='Yes'?'<tr>
                                              <td>
											  	<i class="fa fa-angle-right icon-page-title" aria-hidden="true"></i>
                                                </i>
                                              </td>
 ...
 'INFO_TEXT_TOTAL_JOBS'=>INFO_TEXT_TOTAL_JOBS." ".$no_of_job,
