...
'JOBSEEKER_REGISTER'=>'<a href="'.tep_href_link(FILENAME_JOBSEEKER_REGISTER1).'" class="btn btn-sm btn-secondary">Register Now!</a>',
...
'REC_REGISTER'=>'<a href="'.tep_href_link(FILENAME_RECRUITER_REGISTRATION).'" class="btn btn-sm btn-secondary">Register Now!</a>',
...
'REC_SEARCH_RESUME'=>'<a href="'.tep_href_link(FILENAME_RECRUITER_SEARCH_RESUME).'">Find Resume</a>',
 'ALL_JOBS'=>tep_draw_form('all_jobs', FILENAME_JOB_SEARCH,'','post').tep_draw_hidden_field('action','search').'<a onclick="document.all_jobs.submit()" class="btn btn-sm btn-secondary">View all</a></form>',
...
'JOB_COMPANY'=> $job_company,
 'ALL_COMPANY'=>'<a href="'.tep_href_link(FILENAME_JOBSEEKER_COMPANY_PROFILE).'" class="btn btn-sm btn-secondary">view all</a>',
 'ALL_ARTICLES'=> '<a href="'.tep_href_link(FILENAME_ARTICLE).'" class="btn btn-sm btn-secondary">view all</a>',
