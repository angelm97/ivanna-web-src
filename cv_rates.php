...
if($x > 0)
{
 ...
 while($row = tep_db_fetch_array($result))
 {
  ...
  {
   $buy='<a href="' . tep_href_link(FILENAME_JOBSEEKER_CHECKOUT_PAYMENT,'product_id='.$row['id']).'">buy</a>';
   $row_selected=' class="dataTableRow'.($alternate%2==1?'1':'2').'" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href=\'' . tep_href_link(FILENAME_JOBSEEKER_CHECKOUT_PAYMENT,'product_id='.$row['id']). '\'"';
  }
