...
$template->assign_vars(array(
 ...
 'INFO_TEXT_SITE_TITLE1'        => tep_draw_input_field('TR_site_title',$site_title,'size="60"'),
 'INFO_TEXT_SITE_META_KEYWORDS' =>INFO_TEXT_SITE_META_KEYWORDS,
 'INFO_TEXT_SITE_META_KEYWORDS1'=>tep_draw_textarea_field('meta_keyword', true,70,7,$meta_keyword),
 'INFO_TEXT_SITE_META_DESCRIPTION'=>INFO_TEXT_SITE_META_DESCRIPTION,
 'INFO_TEXT_SITE_META_DESCRIPTION1'=>tep_draw_textarea_field('meta_description', true,70,5,$meta_description),
