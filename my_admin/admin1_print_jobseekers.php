...
switch ($action)
{
 case 'print':
  ...
  $template->assign_vars(array(
   ...
   'new_button'=>'<a href="'.tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_JOBSEEKER_PRINT,tep_get_all_get_params(array('print')).'print=excel').'"  >'.tep_button('Download Excel','class="btn btn-primary"').'</a> <a href="'.tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_JOBSEEKER_PRINT,tep_get_all_get_params(array('print')).'print=print').'" target="_print">'.tep_image(PATH_TO_BUTTON.'button_print.gif', IMAGE_PRINT).'</a>&nbsp;<a href="'.tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_JOBSEEKER_PRINT).'">'.tep_image(PATH_TO_BUTTON.'button_cancel.gif', IMAGE_CANCEL).'</a>',
 ...
 default :
  ...
  $print_fields2=tep_draw_checkbox_field('contact_no','','','','id="contact_no"').'<label for="contact_no" onMouseOver="this.style.color=\'#0000ff\'" onMouseOut="this.style.color=\'#000080\'">'.TABLE_HEADING_TELEPHONE.'</label><br>';
