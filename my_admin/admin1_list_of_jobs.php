...
////////////////
$different_jobs='<a href="'.tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_JOBS, 'page=1&'.tep_get_all_get_params(array('action','page','jobID','j_status','sort','selected_box'))).'&j_status=active">Active Jobs</a>';
$different_jobs.='&nbsp;|&nbsp;<a href="'.tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_JOBS, 'page=1&'.tep_get_all_get_params(array('action','page','jobID','j_status','sort','selected_box'))).'&j_status=expired">Expired Jobs</a>';
$different_jobs.='&nbsp;|&nbsp;<a href="'.tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_JOBS, 'page=1&'.tep_get_all_get_params(array('action','page','jobID','j_status','sort','selected_box'))).'&j_status=deleted">Deleted Jobs</a>';
$different_jobs.='&nbsp;|&nbsp;<a href="'.tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_JOBS, 'page=1&'.tep_get_all_get_params(array('action','page','jobID','j_status','sort','selected_box'))).'&j_status=other">Other Jobs</a>';
/////////////
 ...
 while ($job = tep_db_fetch_array($db_job_query))
 {
  if($action1!='delete')
  {
   ...
   if ( (isset($jInfo) && is_object($jInfo)) && ($job['job_id'] == $jInfo->job_id) )
   {
    ...
    $row_selected=' class="dataTableRowSelected" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" ';//onclick="document.location.href=\'' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_JOBS, tep_get_all_get_params(array('jobID','action','selected_box'))).'&jobID='.$job['job_id'] . '\'"
   }
   else
   {
...
switch ($action)
{
 case 'del_job':
  ...
  <tr>
  <td>
  <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_JOBS, tep_get_all_get_params(array('page','action','selected_box'))).'&action=confirm_delete' . '">'
  .tep_button('Confirm','class="btn btn-delete"').'
  </a>
  </td>
  <td>
  <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_JOBS, tep_get_all_get_params(array('action','selected_box'))) . '">' 
  . tep_button('Cancel','class="btn btn-cancel"') . '
  </a>
  </td>
  </tr>
  </table>
 ...
 default:
  if (is_object($jInfo))
  {
   ...
   . tep_button('Edit','class="btn btn-secondary"') . '   
   </a> 
   </td>
   <td>
   <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_JOBS, tep_get_all_get_params(array('jobID','selected_box'))).'&jobID='.$jInfo->job_id.'&action=del_job' . '">' 
   . tep_button('Delete','class="btn btn-delete"') . '
   </a>   
   </td>
   </tr>
   </table>
...
if($action1=='delete')
{
 ...
 $check_link='<br>'.TEXT_DELETE_WARNING.'<br><br><a href="#"  style="color:#0000ff" onclick="DeleteSelected(\''.$delete_action.'\')">'.tep_button('Confirm','class="btn btn-primary"').'</a>&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_JOBS).'">' . tep_button('Cancel','class="btn btn-primary"') . '</a>';
