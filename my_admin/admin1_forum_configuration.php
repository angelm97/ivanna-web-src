...
$template->assign_vars(array(
 ...
 'INFO_TEXT_MODULE_FORUM_SEARCH_KAYWORD1'  => tep_draw_input_field('IN_min_keyword_length',$min_keyword_length,'size="3"'),
 'INFO_TEXT_MODULE_FORUM_MAXIMUM_RESULT'   => INFO_TEXT_MODULE_FORUM_MAXIMUM_RESULT,
 'INFO_TEXT_MODULE_FORUM_MAXIMUM_RESULT1'  => tep_draw_input_field('IN_max_forum_search_result',$max_forum_search_result,'size="3"',true),
