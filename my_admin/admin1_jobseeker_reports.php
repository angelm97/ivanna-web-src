...
switch ($action)
{
 ...
 if (isset($rInfo) && is_object($rInfo))
 {
  ...
  $contents[] = array('align' => 'center', 'text' => '<br><a href="' . tep_href_link(FILENAME_JOBSEEKER_REGISTER1, 'jID=' . $rInfo->jobseeker_id ) . '">'.tep_button('Edit','class="btn btn-secondary"').'</a>');
...
$template->assign_vars(array(
 ...
 'new_button' => ($x > 0 && $x1 > 0?'<a href="#" onclick="page_submit(\'email\');">'.tep_button('Email','class="btn btn-secondary"').'</a>&nbsp;&nbsp;<a href="#" onclick="page_submit(\'excel\');">'.tep_image(PATH_TO_BUTTON.'button_create_excel_report.gif', IMAGE_EXCEL).'</a>':''),
 ...
 'INFO_TEXT_START_DATE1' => datelisting_admin($start_date, 'name="Date"', 'name="Month"', 'name="Year"', 2006, date("Y"),false),
 'INFO_TEXT_END_DATE' => INFO_TEXT_END_DATE,
 'INFO_TEXT_END_DATE1' => datelisting_admin($end_date, 'name="date"', 'name="month"', 'name="year"', 2006, date("Y"),false),
