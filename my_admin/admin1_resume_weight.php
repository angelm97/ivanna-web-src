...
$template->assign_vars(array(
 ...
 'INFO_TEXT_LOCATION1'=>tep_draw_input_field('IN_location_weight', $location_weight,'onFocus="calculate_total();" onBlur="calculate_total();" size="2"'),
 'INFO_TEXT_INDUSTRY'=>INFO_TEXT_INDUSTRY,
 'INFO_TEXT_INDUSTRY1'=>tep_draw_input_field('IN_industry_weight', $industry_weight,'onFocus="calculate_total();" onBlur="calculate_total();" size="2"'),
 'INFO_TEXT_JOB_TYPE'=>INFO_TEXT_JOB_TYPE,
 'INFO_TEXT_JOB_TYPE1'=>tep_draw_input_field('IN_job_type_weight', $job_type_weight,'onFocus="calculate_total();" onBlur="calculate_total();" size="2"'),
 'INFO_TEXT_EXPERIENCE'=>INFO_TEXT_EXPERIENCE,
 'INFO_TEXT_EXPERIENCE1'=>tep_draw_input_field('IN_experience_weight', $experience_weight,'onFocus="calculate_total();" onBlur="calculate_total();" size="2"'),
 'INFO_TEXT_TOTAL'=>INFO_TEXT_TOTAL,
 'INFO_TEXT_TOTAL1'=>tep_draw_input_field('total', $total,' size="2" readonly style="background-color: #f8f8f8;color:red;"'),
