...
$template->assign_vars(array(
 ...
 'TEXT_INFO_USER_NAME1'=>tep_draw_input_field('TR_User_Name','','',false),
 'TEXT_INFO_PASSWORD'=>TEXT_INFO_PASSWORD,
 'TEXT_INFO_PASSWORD1'=>tep_draw_password_field('TR_Password','',false),
'LOGO'=>'<img src="'.tep_href_link('img/'.DEFAULT_SITE_LOGO).'" width="200">',
 ...
 'new_button'=>'<button type="submit" class="btn btn-primary">Login</button>',//tep_image_submit(PATH_TO_BUTTON.'button_confirm.gif', IMAGE_CONFIRM),
