...
if ( ($action != 'restorelocal') && isset($dir) )
	$backup_buttons.='&nbsp;&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_BACKUP, 'action=restorelocal') . '">'.tep_button('Restore','class="btn btn-primary"').'</a>';
...
switch ($action)
{
 case 'backup':
  ...
  $contents[] = array('align' => 'center', 'text' => '<br>' . tep_draw_submit_button_field('','Backup','class="btn btn-primary"') . '&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_BACKUP) . '">' . tep_button('Cancel','class="btn btn-primary"') . '</a>');
 break;
 case 'restore':
  ...
  $contents[] = array('align' => 'center', 'text' => '<br><a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_BACKUP, 'file=' . $buInfo->file . '&action=restorenow') . '">' . tep_button('Restore','class="btn btn-primary"') . '</a>&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_BACKUP) . '">' . tep_button('Cancel','class="btn btn-primary"') . '</a>');
 break;
 case 'restorelocal':
  ...
  $contents[] = array('align' => 'center', 'text' => '<br>' . tep_draw_submit_button_field('','Restore','class="btn btn-primary"') . '&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_BACKUP) . '">' . tep_button('Cancel','class="btn btn-primary"') . '</a>');
 break;
 case 'delete':
  $heading[] = array('text' => '<b>' . $buInfo->date . '</b>');
  ...
  $contents[] = array('align' => 'center', 'text' => '<br>' . tep_draw_submit_button_field('','Confirm','class="btn btn-primary"') . ' <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_BACKUP) . '">' . tep_button('Cancel','class="btn btn-primary"') . '</a>');
 break;
 default:
  if (isset($buInfo) && is_object($buInfo))
  {
   $heading[] = array('text' => '<b>' . $buInfo->date . '</b>');
   $contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_BACKUP, 'file=' . $buInfo->file . '&action=restore') . '">' . tep_button('Restore','class="btn btn-primary"') . '</a> <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_BACKUP, 'file=' . $buInfo->file . '&action=delete') . '">' . tep_button('Delete','class="btn btn-primary"') . '</a>');
