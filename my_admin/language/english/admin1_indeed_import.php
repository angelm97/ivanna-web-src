<?
define('HEADING_TITLE','Indeed  Feed Import  Management');

define('TABLE_HEADING_INDEED_FEED_NAME','Campaign Name');
define('TABLE_HEADING_INDEED_FEED_PUBLISHER_ID','Publisher ID');
define('TABLE_HEADING_INDEED_FEED_LAST_ACTIVE','Last Active');
define('TABLE_HEADING_INDEED_FEED_IMPORT_JOBS','Import Jobs(last)');
define('TABLE_HEADING_INDEED_FEED_STATUS','Status');
define('TABLE_HEADING_INDEED_FEED_FATCH','Fatch');
...
define('TEXT_INFO_PUBLISHER_ID','Publisher ID');
...
define('MESSAGE_PUBLISHER_ID_ERROR','Invalid Publisher ID.');
...
define('TEXT_PUBLISHER_ID_HELP','Get publisher ID from <a href="https://ads.indeed.com/jobroll/aaup.jsp?hl=en&co=US" class="blue" target="_blank">https://ads.indeed.com/jobroll/aaup.jsp?hl=en&co=US</a>');
?>