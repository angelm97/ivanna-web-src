...
define('TEXT_NEWSLETTER_ATTACHMENT','Attachment:');
...
define('ERROR_NEWSLETTER_CONTENT', 'Error: Newsletter content required');
...
define('EXIST_NEWSLETTER_TITLE_ERROR', 'Error: newsletter title already exist.');

define('MESSAGE_SUCCESS_DELETED','Success: Newsletter Successfully deleted.');
define('MESSAGE_SUCCESS_INSERTED','Success: Newsletter Successfully inserted.');
define('MESSAGE_SUCCESS_UPDATED','Success: Newsletter Successfully updated.');
define('MESSAGE_SUCCESS_SEND','Success: Newsletter Successfully Send.');
...
define('IMAGE_SEND_EMAIL', 'Sending E-mail');
define('IMAGE_LOCK', 'Lock');
define('IMAGE_UNLOCK', 'Unlock');
define('IMAGE_LOCKED', 'Locked');
define('IMAGE_UNLOCKED', 'Unlocked');
define('IMAGE_PREVIEW', 'Preview');
define('IMAGE_NEW', 'New Newsletter');
?>