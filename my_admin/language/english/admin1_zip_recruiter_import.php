<?
define('HEADING_TITLE','ZipRecruiter  Feed Import  Management');

define('TABLE_HEADING_ZIP_RECRUITER_FEED_NAME','Campaign Name');
define('TABLE_HEADING_ZIP_RECRUITER_FEED_API_KEY','Api Key');
define('TABLE_HEADING_ZIP_RECRUITER_FEED_LAST_ACTIVE','Last Active');
define('TABLE_HEADING_ZIP_RECRUITER_FEED_IMPORT_JOBS','Import Jobs(last)');
define('TABLE_HEADING_ZIP_RECRUITER_FEED_STATUS','Status');
define('TABLE_HEADING_ZIP_RECRUITER_FEED_FATCH','Fatch');
...
define('TEXT_INFO_API_KEY','Api Key');
define('TEXT_INFO_RECRUITER_ID','Recruiter ID');
define('TEXT_INFO_LOCATION','Location');
define('TEXT_INFO_LOCATION2','Use a "city, state/province/region" combination like San Francisco, CA.');
...
define('TEXT_INFO_CHANNEL','Channel');
...
define('MESSAGE_API_KEY_ERROR','Invalid Api Key.');
...
define('TEXT_DISPLAY_NUMBER_OF_INDEED_IMPORTER', 'Displaying <b>%d</b> to <b>%d</b> (of <b>%d</b> feed importers)');
define('TEXT_RECRUITER_ID_HELP','Use the ID mentioned in Recruiters section');
define('TEXT_API_KEY_HELP','Get publisher ID from <a href="https://www.ziprecruiter.com/publishers" class="blue" target="_blank">https://www.ziprecruiter.com/publishers</a>');
?>