...
***********************************************************
*/
define('HEADING_TITLE', 'Site backup manager');
...
define('TEXT_BACKUP_DIRECTORY', 'Site backup directory:');

define('ERROR_BACKUP_DIRECTORY_DOES_NOT_EXIST', 'Error: Site backup directory does not exist.');
define('ERROR_BACKUP_DIRECTORY_NOT_WRITEABLE', 'Error: Site backup directory is not writeable.');
define('ERROR_DOWNLOAD_LINK_NOT_ACCEPTABLE', 'Error: Download link not acceptable.');

define('SUCCESS_SITE_BACKUP_SAVED', 'Success: The site backup has been saved.');
define('SUCCESS_BACKUP_DELETED', 'Success: The site backup has been removed.');
