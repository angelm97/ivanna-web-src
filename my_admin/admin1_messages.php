...
if(tep_not_null($mail_id) && $mail_id>0)
{
 ...
 $action=  tep_db_prepare_input($_GET['action']);
  ...
  'INFO_TEXT_USER_NAME1' => tep_draw_input_field('TR_user_name', $user_name, 'size="45"', true ),
  ...
  'INFO_TEXT_YOUR_NAME1' => tep_draw_input_field('TR_your_name', $your_name, 'size="45"', true ),
		'INFO_TEXT_SUBJECT'    => INFO_TEXT_SUBJECT,
  'INFO_TEXT_SUBJECT1'   => tep_draw_input_field('TR_subject', $msg_subject, 'size="45"', true),
  'INFO_TEXT_MESSAGE'    => INFO_TEXT_MESSAGE,
		'JOB_SEARCH_LEFT'      => JOB_SEARCH_LEFT,
  'INFO_TEXT_MESSAGE1'   => tep_draw_textarea_field('TR_message', 'soft', '60%', '10', $message, '', true, true),
 ...
 $template->pparse('send_mail');
  ...
  'INFO_TEXT_BACK'=>'<a href="#" onclick="javascript:window.close();">'.tep_button('Close','class="btn btn-primary"').'</a>&nbsp;&nbsp;',
