...
$template->assign_vars(array(
 ...
 'INFO_TEXT_LINKEDIN_PLUGIN1'    => tep_draw_pull_down_menu('linkedin_plugin_status', $linkedin_status_array, $linkedin_submitter_status,''),
 'INFO_TEXT_LINKEDIN_PLUGIN_KEY' => INFO_TEXT_LINKEDIN_PLUGIN_KEY,
 'INFO_TEXT_LINKEDIN_PLUGIN_KEY1'=> tep_draw_input_field('linkedin_app_key',$linkedin_app_key,'size="40"'),
 'INFO_TEXT_LINKEDIN_PLUGIN_SECRET' => INFO_TEXT_LINKEDIN_PLUGIN_SECRET,
 'INFO_TEXT_LINKEDIN_PLUGIN_SECRET1'=> tep_draw_input_field('linkedin_app_secret',$linkedin_app_secret,'size="60"'),
