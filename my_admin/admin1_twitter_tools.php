...
$template->assign_vars(array(
 ...
 'INFO_TEXT_TWITTER_SUBMITTER1'   => tep_draw_pull_down_menu('twitter_submitter_status', $twitter_status_array, $twitter_submitter_status,''),
 ...
 'INFO_TEXT_TWITTER_CONSUMER_KEY1'=> tep_draw_input_field('twitter_consumer_key',$twitter_consumer_key,'size="40"'),
 'INFO_TEXT_TWITTER_CONSUMER_SECRET' => INFO_TEXT_TWITTER_CONSUMER_SECRET,
 'INFO_TEXT_TWITTER_CONSUMER_SECRET1'=> tep_draw_input_field('twitter_consumer_secret',$twitter_consumer_secret,'size="60"'),
 'INFO_TEXT_TWITTER_ACCESS_TOKEN' => INFO_TEXT_TWITTER_ACCESS_TOKEN,
 'INFO_TEXT_TWITTER_ACCESS_TOKEN1'=> tep_draw_input_field('twitter_access_token',$twitter_access_token,'size="60"'),
 'INFO_TEXT_TWITTER_TOKEN_SECRET' => INFO_TEXT_TWITTER_TOKEN_SECRET,
 'INFO_TEXT_TWITTER_TOKEN_SECRET1'=> tep_draw_input_field('twitter_access_token_secret',$twitter_access_token_secret,'size="49"'),
 ...
 'INFO_TEXT_BITLY_STATUS1'        => tep_draw_pull_down_menu('bitly_status', $twitter_status_array, $bitly_module_status,''),
 'INFO_TEXT_BITLY_USER_ID'        => INFO_TEXT_BITLY_USER_ID,
 'INFO_TEXT_BITLY_USER_ID1'       => tep_draw_input_field('bitly_user_id',$bitly_user_id,'size="40"'),
 'INFO_TEXT_BITLY_API_KEY'        => INFO_TEXT_BITLY_API_KEY,
 'INFO_TEXT_BITLY_API_KEY1'       => tep_draw_input_field('bitly_api_key',$bitly_api_key,'size="40"'),
