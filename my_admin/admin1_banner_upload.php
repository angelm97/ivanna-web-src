...
{ 
 case 'new_banner':
 case 'insert_banner':
	$heading[]=array('text' => '<b>'.TEXT_INFO_HEADING_NEW_BANNER.'</b>');
// creating banner location array from banner_location table
	...
	$contents[]=array('text' => TEXT_INFO_UPLOAD_INTRO);
	$contents[]=array('text' => '<br>'.INFO_TEXT_BANNER_TITLE.'<br>'.tep_draw_input_field('TR_banner_title', $title, '',true ));
 ...
 $contents[]=array('text' => '<br>'.INFO_TEXT_BANNER_ALT.'<br>'.tep_draw_input_field('banner_alt', $alt, '' ));
	...
	$contents[]=array('text' => '<br><div id=script>'.INFO_TEXT_BANNER_SCRIPT.'<br>'.tep_draw_textarea_field('banner_script','','30','4',$script,'',"",false).'</div>');
	...
	$contents[]=array('text' => '<br><br><hr><font size=2><b>'.TEXT_COMPANY_INFO.'</b></font>');
	$contents[]=array('text' => '<br>'.INFO_TEXT_COMPANY_NAME.'<br>'.tep_draw_input_field('company_name', $company_name, '' ));
	$contents[]=array('text' => INFO_TEXT_COMPANY_CONTACT.'<br>'.tep_draw_input_field('company_contact', $company_contact, '' ));
	$contents[]=array('text' => INFO_TEXT_COMPANY_EMAIL.'<br>'.tep_draw_input_field('company_email', $company_email, '' ));
	$contents[]=array('text' => INFO_TEXT_BANNER_COSTING.'<br>'.tep_draw_input_field('banner_costing', $banner_costing, '' ));
	$contents[]=array('text' => INFO_TEXT_COMPANY_COMMENTS.'<br>'.tep_draw_textarea_field('company_comments',1,30,2, $company_comments, '' ));
	$contents[]=array('align' => 'center', 'text' => '<br>'.tep_image_submit(PATH_TO_BUTTON.'button_upload.gif', IMAGE_UPLOAD).'&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_BANNER_UPLOAD).'">'.tep_image_button(PATH_TO_BUTTON.'button_cancel.gif', IMAGE_CANCEL).'</a>');
 break;
}
...
$template->assign_vars(array(
 ...
 'button'=>'<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_BANNER_UPLOAD, 'action=new_banner') . '">'.tep_image_button(PATH_TO_BUTTON.'button_new.gif',IMAGE_NEW).'</a>&nbsp;&nbsp;',
