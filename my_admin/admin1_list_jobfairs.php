...
///only for sorting ends
 ...
 if(tep_db_num_rows($jobfair_query) > 0)
 {
  ...
  while ($jobfair = tep_db_fetch_array($jobfair_query))
  {
   ...
   {
    $row_selected=' id="defaultSelected" class="dataTableRowSelected" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href=\'' . FILENAME_ADMIN1_LIST_OF_JOBFAIRS . '?page='.$_GET['page'].'&id=' . $jInfo->id . '&action=edit\'"';
   }
   else
   {
...
');
 ...
 case 'edit_metatags':
  ...
  $contents[] = array('align' => 'center', 'text' => '<br>'.tep_draw_submit_button_field('','Save','class="btn btn-primary"').'</a>&nbsp;<a href="'
  ...
  if (isset($jInfo) && is_object($jInfo))
   ...
   $contents[] = array('align' => '', 'text' => '
    ...
    <tr>
        ...
        '.tep_button('Delete','class="btn btn-primary"').'
        </a>
        </td>
    </tr>
    <tr>
        ...
        '.tep_button('Title/Metatags','class="btn btn-primary"').'
        </a>
        </td>
    </tr>
    </tbody>
...
*/
 $template->assign_vars(array(
 'INFO_TEXT_JF_TITLE'=>INFO_TEXT_JF_TITLE,
 'INFO_TEXT_JF_TITLE1'=>tep_draw_input_field('TR_jobfair_title',$jobfair_title,'size="45"','class="form-control"',true),
 'INFO_TEXT_JF_LOCATION'=>INFO_TEXT_JF_LOCATION,
 'INFO_TEXT_JF_LOCATION1'=>tep_draw_input_field('TR_jobfair_location',$jobfair_location,'size="45"','class="form-control"',true),
 'INFO_TEXT_JF_VENUE'=>INFO_TEXT_JF_VENUE,
 'INFO_TEXT_JF_VENUE1'			=> tep_draw_textarea_field('TR_jobfair_venue', 'soft', '40', '3', $jobfair_venue, '', '', true),
 'INFO_TEXT_JF_GOOGLEMAP_URL'     => INFO_TEXT_JF_GOOGLEMAP_URL,
 'INFO_TEXT_JF_GOOGLEMAP_URL1'    => tep_draw_textarea_field('TR_jobfair_googlemap_url', 'soft', '70', '4', $jobfair_googlemap_url, '', '', true),//tep_draw_input_field('TR_jobfair_googlemap_url',$jobfair_googlemap_url,'size="45"',true),
 'INFO_TEXT_JF_VIDEO'=>INFO_TEXT_JF_VIDEO,
 'INFO_TEXT_JF_VIDEO1'=>tep_draw_input_field('jobfair_video',$jobfair_video,'class="form-control"',false),
 'INFO_TEXT_JOBFAIR_BEGINDATE'=>INFO_TEXT_JOBFAIR_BEGINDATE,
...
else
{
 $template->assign_vars(array(
  ...
  'new_button'=>'<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_LIST_OF_JOBFAIRS, 'action=new') . '">'.tep_image_button(PATH_TO_BUTTON.'button_new.gif',IMAGE_NEW).'</a>&nbsp;&nbsp;',
 ));
