...
if(tep_db_num_rows($job_alert_direct_query) > 0)
{
 ...
 while ($job_alert_direct = tep_db_fetch_array($job_alert_direct_query))
 {
  ...
  {
   $row_selected=' id="defaultSelected" class="dataTableRowSelected" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href=\'' . FILENAME_ADMIN1_ADMIN_JOB_ALERT_DIRECT . '?page='.$_GET['page'].'&id=' . $cInfo->id . '&action=edit\'"';
  }
  else
  {
...
switch ($action)
{
 case 'delete':
  ...
  <table>
   ...
   <td>
   <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_ADMIN_JOB_ALERT_DIRECT, 'page=' . $_GET['page'] . '&job_alert_direct_id=' . $job_alert_direct_id) . '">' 
 ...
 default:
  if (isset($cInfo) && is_object($cInfo))
   ...
   $contents[] = array('align' => 'center', 'text' => '<br><a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_ADMIN_JOB_ALERT_DIRECT, 'page=' . $_GET['page'] .'&job_alert_direct_id=' . $cInfo->id . '&action=edit') . '">'.tep_image_button(PATH_TO_BUTTON.'button_edit.gif',IMAGE_EDIT).'</a>&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_ADMIN_JOB_ALERT_DIRECT, 'page=' . $_GET['page'] .'&job_alert_direct_id=' . $cInfo->id . '&action=delete') . '">'.tep_image_button(PATH_TO_BUTTON.'button_delete.gif',IMAGE_DELETE).'</a>');
...
$template->assign_vars(array(
 ...
 'INFO_TEXT_JOB_ALERT_DIRECT_NAME1'=>tep_draw_input_field('TR_job_alert_direct_name', $job_alert_direct_name, 'size="35"', true ).'&nbsp;'.tep_draw_checkbox_field('default', 'Yes', false, $default, 'id="check_box_default"') . ' <label for="check_box_default">' . TEXT_SET_DEFAULT.'</label>',
 'INFO_TEXT_JOB_ALERT_DIRECT_PRIORITY'=>INFO_TEXT_JOB_ALERT_DIRECT_PRIORITY,
 'INFO_TEXT_JOB_ALERT_DIRECT_PRIORITY1'=>tep_draw_input_field('IN_priority', $priority, 'size="5"', true ),
 'INFO_TEXT_JOB_ALERT_DIRECT_DESCRIPTION'=>INFO_TEXT_JOB_ALERT_DIRECT_DESCRIPTION,
 'INFO_TEXT_JOB_ALERT_DIRECT_DESCRIPTION1'=>tep_draw_textarea_field('description2', 'soft', '60%', '10', $description, ' style="height: 300px; width: 800px;"  id="description2"', true, true),
 'INFO_TEXT_FR_JOB_ALERT_DIRECT_DESCRIPTION'=>INFO_TEXT_FR_JOB_ALERT_DIRECT_DESCRIPTION,
 'INFO_TEXT_FR_JOB_ALERT_DIRECT_DESCRIPTION1'=>tep_draw_textarea_field('fr_description2', 'soft', '60%', '10', $fr_description, ' style="height: 300px; width: 800px;"  id="fr_description2"', true, true),
 'HOST_NAME'                       =>HOST_NAME,
 ...
 'new_button'=>'<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_ADMIN_JOB_ALERT_DIRECT, 'page=' . $_GET['page'] .'&action=new') . '">'.tep_image_button(PATH_TO_BUTTON.'button_new.gif',IMAGE_NEW).'</a>&nbsp;&nbsp;',
