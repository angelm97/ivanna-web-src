...
if($_GET['gPath']) 
{
 ...
 if($_GET['gPath'] != 1) 
 {
  $buttons='<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'gID=' . $_GET['gPath']) . '">' . tep_image_button(PATH_TO_BUTTON.'button_cancel.gif', IMAGE_CANCEL) . '</a> ' . tep_image_submit(PATH_TO_BUTTON.'button_save.gif', IMAGE_INSERT); 
 } 
 else 
 { 
  $buttons=tep_image_submit(PATH_TO_BUTTON.'button_back.gif', IMAGE_BACK); 
 }
} 
elseif ($_GET['gID']) 
{
 ...
 if($db_groups_num_row > 0)
 {
  ...
  while ($groups = tep_db_fetch_array($db_groups_query)) 
  {
   ...
   {
    $row_selected=' id="defaultSelected" class="dataTableRowSelected" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href=\'' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'gID=' . $groups['admin_groups_id'] . '&action=edit_group') . '\'"';
   } 
   else 
   {
 ...
 if($db_admin_num_row > 0)
 {
  ...
  while ($admin = tep_db_fetch_array($db_admin_query)) 
  {
   ...
   if ( (is_object($mInfo)) && ($admin['admin_id'] == $mInfo->admin_id) ) 
			{
				$row_selected=' id="defaultSelected" class="dataTableRowSelected" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href=\'' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'page=' . $_GET['page'] . '&mID=' . $admin['admin_id'] . '&action=edit_member') . '\'"';
			}
			else
			{
...
{  
 ...
 $contents[] = array('text' => '<br>&nbsp;' . TEXT_INFO_LOGINNAME . '<br>&nbsp;' . tep_draw_input_field('TR_login_name')); 
 $contents[] = array('text' => '<br>&nbsp;' . TEXT_INFO_FIRSTNAME . '<br>&nbsp;' . tep_draw_input_field('TR_firstname')); 
 $contents[] = array('text' => '<br>&nbsp;' . TEXT_INFO_LASTNAME . '<br>&nbsp;' . tep_draw_input_field('TR_lastname'));
 $contents[] = array('text' => '<br>&nbsp;' . TEXT_INFO_EMAIL . '<br>&nbsp;' . tep_draw_input_field('TREF_email_address')); 
 ...
 $contents[] = array('text' => '<br>&nbsp;' . TEXT_INFO_GROUP . '<br>&nbsp;' . tep_draw_pull_down_menu('TR_group_level', $groups_array)); 
 $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit(PATH_TO_BUTTON.'button_insert.gif', IMAGE_INSERT) . ' <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'page=' . $_GET['page'] . '&mID=' . $_GET['mID']) . '">' . tep_image_button(PATH_TO_BUTTON.'button_cancel.gif', IMAGE_CANCEL) . '</a>');    
 break;
 case 'edit_member': 
 $heading[] = array('text' => '<b>' . TEXT_INFO_HEADING_NEW . '</b>');
 ...
 $contents[] = array('text' => '<br>&nbsp;' . TEXT_INFO_LOGINNAME . '<br>&nbsp;' . tep_draw_input_field('TR_login_name', $mInfo->admin_name)); 
 $contents[] = array('text' => '<br>&nbsp;' . TEXT_INFO_FIRSTNAME . '<br>&nbsp;' . tep_draw_input_field('TR_firstname', $mInfo->admin_firstname)); 
 $contents[] = array('text' => '<br>&nbsp;' . TEXT_INFO_LASTNAME . '<br>&nbsp;' . tep_draw_input_field('TR_lastname', $mInfo->admin_lastname));
 $contents[] = array('text' => '<br>&nbsp;' . TEXT_INFO_EMAIL . '<br>&nbsp;' . tep_draw_input_field('TREF_email_address', $mInfo->admin_email_address)); 
 if ($mInfo->admin_id == 1) 
 {      
 ...
 $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit(PATH_TO_BUTTON.'button_update.gif', IMAGE_UPDATE) . ' <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'page=' . $_GET['page'] . '&mID=' . $_GET['mID']) . '">' . tep_image_button(PATH_TO_BUTTON.'button_cancel.gif', IMAGE_CANCEL) . '</a>');    
 break;
 case 'del_member': 
 $heading[] = array('text' => '<b>' . TEXT_INFO_HEADING_DELETE . '</b>');
 if ($mInfo->admin_id == 1 || $mInfo->admin_email_address == STORE_OWNER_EMAIL_ADDRESS) 
 {
  $contents[] = array('align' => 'center', 'text' => '<br><a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'page=' . $_GET['page'] . '&mID=' . $mInfo->admin_id) . '">' . tep_image_button(PATH_TO_BUTTON.'button_back.gif', IMAGE_BACK) . '</a><br>&nbsp;');
 } 
 else 
 {
  ...
  $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit(PATH_TO_BUTTON.'button_delete.gif', IMAGE_DELETE) . ' <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'page=' . $_GET['page'] . '&mID=' . $_GET['mID']) . '">' . tep_image_button(PATH_TO_BUTTON.'button_cancel.gif', IMAGE_CANCEL) . '</a>');    
 }
 break;
 case 'new_group':
 ...
 $contents[] = array('align' => 'center', 'text' => tep_draw_input_field('TR_group_name'));      
 $contents[] = array('align' => 'center', 'text' => '<br><a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'gID=' . $gInfo->admin_groups_id) . '">' . tep_image_button(PATH_TO_BUTTON.'button_cancel.gif', IMAGE_CANCEL) . '</a> ' . tep_image_submit(PATH_TO_BUTTON.'button_next.gif', IMAGE_NEXT) );    
 break;
 case 'edit_group': 
 ...
 $contents[] = array('align' => 'center', 'text' => TEXT_INFO_EDIT_GROUP_INTRO . '<br>&nbsp;<br>' . tep_draw_input_field('TR_group_level', $gInfo->admin_groups_name)); 
 $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit(PATH_TO_BUTTON.'button_save.gif', IMAGE_SAVE) . ' <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'gID=' . $gInfo->admin_groups_id) . '">' . tep_image_button(PATH_TO_BUTTON.'button_cancel.gif', IMAGE_CANCEL) . '</a>');    
 break;
 case 'del_group': 
 ...
 if ($gInfo->admin_groups_id == 1) 
 {
  ...
  $contents[] = array('align' => 'center', 'text' => '<br><a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'gID=' . $_GET['gID']) . '">' . tep_image_button(PATH_TO_BUTTON.'button_back.gif', IMAGE_BACK) . '</a><br>&nbsp;');
 } 
 else 
 {
  ...
  $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit(PATH_TO_BUTTON.'button_delete.gif', IMAGE_DELETE) . ' <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'gID=' . $_GET['gID']) . '">' . tep_image_button(PATH_TO_BUTTON.'button_cancel.gif', IMAGE_CANCEL) . '</a><br>&nbsp;');    
 }
 break;
 case 'define_group':      
 ...
 if ($_GET['gPath'] == 1) 
 {
  $contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'gID=' . $_GET['gPath']) . '">' . tep_image_button(PATH_TO_BUTTON.'button_back.gif', IMAGE_CANCEL) . '</a><br>');      
 }
 break;
 default:
 if (is_object($mInfo)) 
 {
  ...
  $contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'page=' . $_GET['page'] . '&mID=' . $mInfo->admin_id . '&action=edit_member') . '">' . tep_image_button(PATH_TO_BUTTON.'button_edit.gif', IMAGE_EDIT) . '</a> <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'page=' . $_GET['page'] . '&mID=' . $mInfo->admin_id . '&action=del_member') . '">' . tep_image_button(PATH_TO_BUTTON.'button_delete.gif', IMAGE_DELETE) . '</a><br>&nbsp;');
 ...
 {
  $heading[] = array('text' => '<b>&nbsp;' . tep_db_output($gInfo->admin_groups_name) . '</b>');
  $contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'gPath=' . $gInfo->admin_groups_id . '&action=define_group') . '">' . tep_image_button(PATH_TO_BUTTON.'button_admin_permission.gif', IMAGE_FILE_PERMISSION) . '</a> <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'gID=' . $gInfo->admin_groups_id . '&action=edit_group') . '">' . tep_image_button(PATH_TO_BUTTON.'button_edit.gif', IMAGE_EDIT) . '</a> <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'gID=' . $gInfo->admin_groups_id . '&action=del_group') . '">' . tep_image_button(PATH_TO_BUTTON.'button_delete.gif', IMAGE_DELETE) . '</a>');
...
else if($_GET['gID'])
{
 $template->assign_vars(array(
  ...
  'new_button'=>'<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS) . '">' . tep_image_button(PATH_TO_BUTTON.'button_back.gif', IMAGE_BACK) . '</a> <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'gID=' . $gInfo->admin_groups_id . '&action=new_group') . '">' . tep_image_button(PATH_TO_BUTTON.'button_admin_group.gif', IMAGE_NEW_GROUP) . '</a>',
  'RIGHT_BOX_WIDTH'=>$RIGHT_BOX_WIDTH,
  'ADMIN_RIGHT_HTML'=>$ADMIN_RIGHT_HTML,
  'update_message'=>$messageStack->output()));
...
else
{
 $template->assign_vars(array(
  ...
  'new_button'=>'<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'gID=groups') . '">' . tep_image_button(PATH_TO_BUTTON.'button_admin_groups.gif', IMAGE_GROUPS) . '</a>&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_MEMBERS, 'page=' . $_GET['page'] . '&mID=' . $mInfo->admin_id . '&action=new_member') . '">' . tep_image_button(PATH_TO_BUTTON.'button_admin_member.gif', IMAGE_NEW_MEMBER) . '</a>',
  'RIGHT_BOX_WIDTH'=>$RIGHT_BOX_WIDTH,
  'ADMIN_RIGHT_HTML'=>$ADMIN_RIGHT_HTML,
  'update_message'=>$messageStack->output()));
