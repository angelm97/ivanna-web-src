...
else
{
	...
	$invoice_text=' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.HEADING_TITLE_STATUS . ' ' . tep_draw_pull_down_menu('status', array_merge(array(array('id' => '', 'text' => TEXT_ALL_INVOICES)), $invoices_statuses), $_GET['status'], 'class="form-control" onChange="this.form.submit();"');
	if (isset($_GET['cID']))
	{
