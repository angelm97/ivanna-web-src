...
if($action=='')
{
	...
	$minimum_rating_string.=tep_draw_pull_down_menu('minimum_rating', $minimum_rating_array, $minimum_rating, 'class=label', false);

	$maximum_rating_array=array();
	$maximum_rating_array[0]=array("id"=>'',"text"=>INFO_TEXT_ALL);
	for($j=1;$j<=10;$j++)
		$maximum_rating_array[]=array("id"=>$j,"text"=>$j);
	$maximum_rating_string.=tep_draw_pull_down_menu('maximum_rating', $maximum_rating_array, $maximum_rating, 'class=label', false);
 ...
 'INFO_TEXT_FIRST_NAME1'   => tep_draw_input_field('first_name', $first_name,'size="30"',false),
 'INFO_TEXT_LAST_NAME'     => INFO_TEXT_LAST_NAME,
 'INFO_TEXT_LAST_NAME1'    => tep_draw_input_field('last_name', $last_name,'size="30"',false),
 ...
 'INFO_TEXT_COUNTRY1'      => LIST_TABLE(COUNTRIES_TABLE,"country_name"," priority ,country_name","name='country' ","All countries","",$country),
 'INFO_TEXT_STATE'         => INFO_TEXT_STATE,
 'INFO_TEXT_STATE1'        => tep_draw_input_field('state1', $state,'size="25"',false),
 ...
 'INFO_TEXT_JOB_CATEGORY1' => get_drop_down_list(JOB_CATEGORY_TABLE,"name='industry_sector[]' size='6' multiple","All Job Categorys","0",$industry_sector1),
 'INFO_TEXT_EXPERIENCE'    => INFO_TEXT_EXPERIENCE,
 'INFO_TEXT_EXPERIENCE1'   => experience_drop_down('name="experience"', 'Any experience', '', $experience),
