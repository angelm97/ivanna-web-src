...
$template->assign_vars(array(
 ...
 'INFO_TEXT_G_CAPTCHA_PLUGIN1'       => tep_draw_pull_down_menu('g_recaptcha_status', $gcaptcha_status_array, $g_recaptcha_status,''),
 'INFO_TEXT_G_CAPTCHA_PLUGIN_KEY'    => INFO_TEXT_G_CAPTCHA_PLUGIN_KEY,
 'INFO_TEXT_G_CAPTCHA_PLUGIN_KEY1'   => tep_draw_input_field('g_recaptcha_key',$g_recaptcha_key,'size="40"'),
 'INFO_TEXT_G_CAPTCHA_PLUGIN_SECRET' => INFO_TEXT_G_CAPTCHA_PLUGIN_SECRET,
 'INFO_TEXT_G_CAPTCHA_PLUGIN_SECRET1'=> tep_draw_input_field('g_recaptcha_secret',$g_recaptcha_secret,'size="60"'),
