...
if(tep_not_null($action))
{
 switch($action)
 {
  case 'search':
   ...
   $field_names="rl.recruiter_id,concat(r.recruiter_first_name,' ',r.recruiter_last_name) as name,rl.recruiter_email_address,rl.inserted,rl.updated, rl.recruiter_status, rl.ip_address, rl.last_login_time, rl.number_of_logon";
...
switch ($action)
{
 ...
 if (isset($rInfo) && is_object($rInfo))
 {
  ...
  $contents[] = array('align' => 'center', 'text' => '<br><a href="' . tep_href_link(FILENAME_RECRUITER_REGISTRATION, 'rID=' . $rInfo->recruiter_id ) . '">'.tep_image_button(PATH_TO_BUTTON.'button_edit.gif',IMAGE_EDIT).'</a>');
...
$template->assign_vars(array(
 ...
 'new_button' => ($x > 0 && $x1 > 0?'<a href="#" onclick="page_submit(\'email\');">'.tep_image(PATH_TO_BUTTON.'button_email.gif', IMAGE_EMAIL).'</a>':''),
 ...
 'INFO_TEXT_COMPANY_NAME1' => tep_draw_input_field('company', $company,'size="30"',false),
 'INFO_TEXT_START_DATE' => INFO_TEXT_START_DATE,
 'INFO_TEXT_START_DATE1' => datelisting_admin($start_date, 'name="Date"', 'name="Month"', 'name="Year"', 2004, date("Y"),false),
 'INFO_TEXT_END_DATE' => INFO_TEXT_END_DATE,
 'INFO_TEXT_END_DATE1' => datelisting_admin($end_date, 'name="date"', 'name="month"', 'name="year"', 2004, date("Y"),false),
 'INFO_TEXT_FIRST_NAME' => INFO_TEXT_FIRST_NAME,
 'INFO_TEXT_FIRST_NAME1' => tep_draw_input_field('first_name', $first_name,'size="20"',false),
 'INFO_TEXT_LAST_NAME' => INFO_TEXT_LAST_NAME,
 'INFO_TEXT_LAST_NAME1' => tep_draw_input_field('last_name', $last_name,'size="20"',false),
 'INFO_TEXT_EMAIL_ADDRESS' => INFO_TEXT_EMAIL_ADDRESS,
 'INFO_TEXT_EMAIL_ADDRESS1' => tep_draw_input_field('email_address', $email_address,'size="30"',false),
 'INFO_TEXT_COUNTRY' => INFO_TEXT_COUNTRY,
 'INFO_TEXT_COUNTRY1' => tep_get_country_list('country'),
