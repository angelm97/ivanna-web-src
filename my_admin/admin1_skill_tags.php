...
if(tep_db_num_rows($skill_tag_query) > 0)
{
 ...
 while ($skill_tag = tep_db_fetch_array($skill_tag_query))
 {
  ...
  {
   $row_selected=' id="defaultSelected" class="dataTableRowSelected" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href=\'' . FILENAME_ADMIN1_ADMIN_SKILL_TAGS . '?page='.$_GET['page'].'&id=' . $cInfo->id . '&action=edit\'"';
  }
  else
  {
...
switch ($action)
{
 ...
 case 'insert':
 case 'save':
  $heading[] = array('text' => '<b>'.TEXT_INFO_HEADING_SKILL_TAG.'</b>');
  ...
  $contents[] = array('text' => '<br>'.TEXT_INFO_SKILL_TAG_NAME.'<br>'.tep_draw_input_field('TR_skill_tag_key', $_POST['TR_skill_tag_key'], '' ));
  ...
  $contents[] = array('align' => 'center', 'text' => '<br>'.tep_image_submit(PATH_TO_BUTTON.'button_insert.gif', IMAGE_INSERT).'&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_ADMIN_SKILL_TAGS).'">'.tep_image_button(PATH_TO_BUTTON.'button_cancel.gif', IMAGE_CANCEL).'</a>');
  break;
 case 'edit':
  ...
  $contents[] = array('text' => '<br>'.TEXT_INFO_SKILL_TAG_NAME.'<br>'.tep_draw_input_field('TR_skill_tag_key', $cInfo->tag, '' ));
  ...
  $contents[] = array('align' => 'center', 'text' => '<br>'.tep_image_submit(PATH_TO_BUTTON.'button_update.gif',IMAGE_UPDATE).'&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_ADMIN_SKILL_TAGS, 'gid=' . $_GET['gid'] . '&id=' . $cInfo->id ). '">'.tep_image_button(PATH_TO_BUTTON.'button_cancel.gif',IMAGE_CANCEL).'</a>');
  break;
 case 'delete':
  $heading[] = array('text' => '<b>' . $cInfo->tag . '</b>');
  ...
  <table>
   <tr>
   <td>       
   <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_ADMIN_SKILL_TAGS, 'page=' . $_GET['page'] . '&id=' . $_GET['id'].'&action=confirm_delete') . '">'
   .tep_image_button(PATH_TO_BUTTON.'button_confirm.gif', IMAGE_CONFIRM).'</a>
   </td>
   <td>
   <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_ADMIN_SKILL_TAGS, 'page=' . $_GET['page'] . '&id=' . $_GET['id']) . '">' 
 ...
 default:
  if (isset($cInfo) && is_object($cInfo))
   ...
   <tr>
   <td>       
   <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_ADMIN_SKILL_TAGS, 'page=' . $_GET['page'] .'&id=' . $cInfo->id . '&action=edit') . '">'
   .tep_image_button(PATH_TO_BUTTON.'button_edit.gif',IMAGE_EDIT).'</a>
   </td>
   <td>
   <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_ADMIN_SKILL_TAGS, 'page=' . $_GET['page'] .'&id=' . $cInfo->id . '&action=delete') . '">'
   .tep_image_button(PATH_TO_BUTTON.'button_delete.gif',IMAGE_DELETE).'</a>
   </td>
   </tr>
   </table>
   ');
...
$template->assign_vars(array(
 ...
 'INFO_TEXT_STATUS1'=>tep_draw_pull_down_menu('skill_status', $skill_status_array, $skill_status1,'onchange="document.disply.submit();"'),
 ...
 'new_button'=>'<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_ADMIN_SKILL_TAGS, 'page=' . $_GET['page'] .'&action=new') . '">'.tep_image_button(PATH_TO_BUTTON.'button_new.gif',IMAGE_NEW).'</a>&nbsp;&nbsp;',
