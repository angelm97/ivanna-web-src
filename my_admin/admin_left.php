...
$heading[] = array('text'  =>BOX_HEADING_DASHBOARD,
                   ...
                   'text_image'=>'<i class="fas fa-tachometer-alt admin-left-icon"></i>',
                   );
$box = new left_box;
...
if (tep_admin_check_boxes('admin_mobile.php') == true)
{
 include_once(PATH_TO_MAIN_PHYSICAL_BOX.'admin_mobile.php');
}
