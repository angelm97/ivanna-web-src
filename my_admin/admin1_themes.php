...
if($action!="")
{
 ...
 if($theme==$default_theme)
  ...
  $screenshot         = tep_not_null(!$rows['screenshot'])?'':'<a href="#" onclick="show_image(\''.tep_href_link(FILENAME_IMAGE."?image_name=".PATH_TO_THEMES."/".$theme.'/'.$rows['screenshot']."&size=800").'\')" title="click me for large view">'.tep_image(FILENAME_IMAGE."?image_name=".PATH_TO_THEMES."/".$theme.'/'.$rows['screenshot']."&size=250").'</a>';
  $screenshot1         = tep_not_null(!$rows['screenshot'])?'':'<a onclick="show_image(\''.tep_href_link(FILENAME_IMAGE."?image_name=".PATH_TO_THEMES."/".$theme.'/'.$rows['screenshot']."&size=800").'\')" title="click me for large view">'.tep_image(FILENAME_IMAGE."?image_name=".PATH_TO_THEMES."/".$theme.'/'.$rows['screenshot']."&size=300",'','','','id="default_main_screenshot"').'</a>';
