...
switch ($action)
{
 case 'delete':
  ...
  $contents[] = array('align' => 'center', 'text' => '<br><a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_PAID_JOBSEEKERS, tep_get_all_get_params(array('page','action','selected_box'))).'&action=confirm_delete' . '">'.tep_button('Confirm','class="btn btn-delete"').'</a>&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_PAID_JOBSEEKERS, tep_get_all_get_params(array('action','selected_box'))) . '">' . tep_button('Cancel','class="btn btn-cancel"') . '</a>');
 ...
 if (isset($rInfo) && is_object($rInfo))
 {
  ...
  $contents[] = array('align' => 'center', 'text' => '<br><a href="' . tep_href_link(FILENAME_JOBSEEKER_REGISTER1, 'jID=' . $rInfo->jobseeker_id ) . '">'.tep_button('Edit','class="btn btn-secondary"').'</a>&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_PAID_JOBSEEKERS, tep_get_all_get_params(array('jID','selected_box'))).'&jID=' . $rInfo->jobseeker_id.'&action=delete' . '">'.tep_button('Delete','class="btn btn-delete"').'</a>');
...
if($action1=='delete')
{
 $check_link='<br>'.TEXT_DELETE_WARNING.'<br><br><a href="#"  style="color:#0000ff" onclick="DeleteSelected(\'confirm_bulk_delete\')">'.tep_button('Confirm','class="btn btn-primary"').'</a>&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_PAID_JOBSEEKERS).'">' . tep_button('Cancel','class="btn btn-primary"') . '</a>';
