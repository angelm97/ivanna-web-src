...
//   'count_rows'=>sprintf(TEXT_DISPLAY_NUMBER_OF_RECRUITERS,($db_recruiter_num_row>0?1:0),$db_recruiter_num_row,$db_recruiter_num_row),//$db_jobseeker_split->display_count($db_jobseeker_query_numrows, MAX_DISPLAY_SEARCH_RESULTS, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_JOBSEEKERS),
   ...
   'new_button'=>'<a class="btn btn-primary" href="'.tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_PRINT,tep_get_all_get_params(array('print')).'print=excel').'">Download Excel</a> <a href="'.tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_PRINT,tep_get_all_get_params(array('print')).'print=print').'" target="_print">'.tep_image(PATH_TO_BUTTON.'button_print.gif', IMAGE_PRINT).'</a>&nbsp;<a href="'.tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_PRINT).'">'.tep_image(PATH_TO_BUTTON.'button_cancel.gif', IMAGE_CANCEL).'</a>',
 ...
 break;
 default :
  $print_fields1=tep_draw_checkbox_field('name','','','','id="name"').'<label for="name" onMouseOver="this.style.color=\'#0000ff\'" onMouseOut="this.style.color=\'#000080\'">'.TABLE_HEADING_NAME.'</label><br>';
  $print_fields1.=tep_draw_checkbox_field('email_address','','','','id="email_address"').'<label for="email_address" onMouseOver="this.style.color=\'#0000ff\'" onMouseOut="this.style.color=\'#000080\'">'.TABLE_HEADING_EMAIL.'</label><br>';
  $print_fields1.=tep_draw_checkbox_field('address','','','','id="address"').'<label for="address" onMouseOver="this.style.color=\'#0000ff\'" onMouseOut="this.style.color=\'#000080\'">'.TABLE_HEADING_ADDRESS.'</label><br>';

  $print_fields2=tep_draw_checkbox_field('position','','','','id="position"').'<label for="position" onMouseOver="this.style.color=\'#0000ff\'" onMouseOut="this.style.color=\'#000080\'">'.TABLE_HEADING_POSITION.'</label><br>';
  $print_fields2.=tep_draw_checkbox_field('company','','','','id="company"').'<label for="company" onMouseOver="this.style.color=\'#0000ff\'" onMouseOut="this.style.color=\'#000080\'">'.TABLE_HEADING_COMPANY.'</label><br>';
  $print_fields2.=tep_draw_checkbox_field('telephone','','','','id="telephone"').'<label for="telephone" onMouseOver="this.style.color=\'#0000ff\'" onMouseOut="this.style.color=\'#000080\'">'.TABLE_HEADING_TELEPHONE.'</label><br>';

  $form=tep_draw_form('page', PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_PRINT, '','get', '').tep_draw_hidden_field('action', 'print');

  $template->assign_vars(array(
   'new_button'=>tep_image_submit(PATH_TO_BUTTON.'button_print.gif', IMAGE_PRINT),
   'HEADING_TITLE'=>HEADING_TITLE,
