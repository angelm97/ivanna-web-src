...
switch ($action)
{
 ...
 if (isset($rInfo) && is_object($rInfo))
 {
  ...
  $contents[] = array('align' => 'left', 'params'=>'class="dataTableRightRow1" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"','text' => '<i class="fa fa-angle-right" aria-hidden="true"></i> <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_LIST_OF_RECRUITER_PARTICIPATE_JOBFAIR, tep_get_all_get_params(array('rID','selected_box'))).'&rID=' . $rInfo->recruiter_id.'&action=delete'.'" class="right_black">'.IMAGE_DELETE.'</a>');
...
if($action1=='delete')
{
 $check_link='<br>'.TEXT_DELETE_WARNING.'<br><br><a href="#"  style="color:#0000ff" onclick="DeleteSelected(\'confirm_bulk_delete\')"><button class="btn btn-primary">Confirm</button></a>&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_LIST_OF_RECRUITER_PARTICIPATE_JOBFAIR).'"><button class="btn btn-secondary">Cancel</button></a>';
