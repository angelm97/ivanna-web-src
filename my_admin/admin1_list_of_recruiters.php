    ...
    if(isset($_POST['recruiter_ids']) && count($_POST['recruiter_ids'])>0)
    {
     ...
     for($i=0;$i<$total_recruiter_ids;$i++)
     {
      ...
      while($jobs=tep_db_fetch_array($result_jobs))
      {
	   ...
	   tep_db_query("delete from ".ZIP_RECRUITER_JOB_TABLE." where job_id='".$job_id."'");
...
switch ($action)
{
 case 'delete':
  ...
  $contents[] = array('align' => 'center', 'text' => '<br><a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITERS, tep_get_all_get_params(array('page','action','selected_box'))).'&action=confirm_delete' . '"><button class="btn btn-primary">Confirm</button></a>&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITERS, tep_get_all_get_params(array('action','selected_box'))) . '"><button class="btn btn-primary">Cancel</button></a>');
 ...
 if (isset($rInfo) && is_object($rInfo))
 {
  ...
  $contents[] = array('align' => 'left', 'params'=>'class="dataTableRightRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"','text' => '<i class="fa fa-angle-right" aria-hidden="true"></i> <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_JOBS, 'rID=' . $rInfo->recruiter_id ).'" class="right_black">'.IMAGE_JOBS.'</a>');
  $contents[] = array('align' => 'left', 'params'=>'class="dataTableRightRow1" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"','text' => '<i class="fa fa-angle-right" aria-hidden="true"></i> <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_ORDERS, 'rID=' . $rInfo->recruiter_id ).'" class="right_black">'.IMAGE_ORDERS.'</a>');
  $contents[] = array('align' => 'left', 'params'=>'class="dataTableRightRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"','text' => '<i class="fa fa-angle-right" aria-hidden="true"></i> <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_ACCOUNTS, 'plan_for=job_post&rID=' . $rInfo->recruiter_id ).'" class="right_black">'.IMAGE_RECRUITER_ACCOUNT_JOB.'</a>');
  $contents[] = array('align' => 'left', 'params'=>'class="dataTableRightRow1" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"','text' => '<i class="fa fa-angle-right" aria-hidden="true"></i> <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_ACCOUNTS, 'plan_for=resume_search&rID=' . $rInfo->recruiter_id ).'" class="right_black">'.IMAGE_RECRUITER_ACCOUNT_RESUME.'</a>');
  $contents[] = array('align' => 'left', 'params'=>'class="dataTableRightRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"','text' => '<i class="fa fa-angle-right" aria-hidden="true"></i> <a href="' . tep_href_link(FILENAME_RECRUITER_REGISTRATION, 'rID=' . $rInfo->recruiter_id ).'" class="right_black">'.IMAGE_EDIT.'</a>');
  $contents[] = array('align' => 'left', 'params'=>'class="dataTableRightRow1" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"','text' => '<i class="fa fa-angle-right" aria-hidden="true"></i> <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITERS, tep_get_all_get_params(array('rID','selected_box'))).'&rID=' . $rInfo->recruiter_id.'&action=delete'.'" class="right_black">'.IMAGE_DELETE.'</a>');
  $contents[] = array('align' => 'left', 'params'=>'class="dataTableRightRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"','text' => '<i class="fa fa-angle-right" aria-hidden="true"></i> <a href="' . tep_href_link(FILENAME_RECRUITER_CONTROL_PANEL, 'rID=' . $rInfo->recruiter_id ).'" class="right_black">'.INFO_TEXT_RECRUITER_CONTROL_PANEL.'</a>');
...
// $check_link='<br>'.TEXT_DELETE_WARNING.'<br><br><a href="#"  style="color:#0000ff" onclick="DeleteSelected(\'confirm_bulk_delete\')"><button class="btn btn-primary">Confirm</button></a>&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITERS).'"><button class="btn btn-secondary">Cancel</button></a>';
 $check_link='<br>'.TEXT_DELETE_WARNING.'<br><br><a href="#" onclick="DeleteSelected(\'confirm_bulk_delete\')" type="button" class="btn btn-primary">Confirm</a>&nbsp;<button onclick="location.href=\''.tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITERS).'\'" type="submit" class="btn btn-secondary">Cancel</a>';
...
'TABLE_HEADING_NO_OF_ACTIVE_JOBS_POSTED'=>TABLE_HEADING_NO_OF_ACTIVE_JOBS_POSTED,
 ...
 'new_button'=>'<a href="' . tep_href_link(FILENAME_RECRUITER_REGISTRATION, 'add=recruiter') . '">' . tep_image_button(PATH_TO_BUTTON.'button_new.gif', IMAGE_NEW) . '</a>',
  ));
}
$template->assign_vars(array(
