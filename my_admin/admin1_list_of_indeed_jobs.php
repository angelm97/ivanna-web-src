...
////////////////
$different_jobs='<a href="'.tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_INDEED_JOBS, 'page=1&'.tep_get_all_get_params(array('action','page','jobID','j_status','sort','selected_box'))).'&j_status=active">Active Jobs</a>';
$different_jobs.='&nbsp;|&nbsp;<a href="'.tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_INDEED_JOBS, 'page=1&'.tep_get_all_get_params(array('action','page','jobID','j_status','sort','selected_box'))).'&j_status=expired">Expired Jobs</a>';
$different_jobs.='&nbsp;|&nbsp;<a href="'.tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_INDEED_JOBS, 'page=1&'.tep_get_all_get_params(array('action','page','jobID','j_status','sort','selected_box'))).'&j_status=deleted">Deleted Jobs</a>';
$different_jobs.='&nbsp;|&nbsp;<a href="'.tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_INDEED_JOBS, 'page=1&'.tep_get_all_get_params(array('action','page','jobID','j_status','sort','selected_box'))).'&j_status=other">Other Jobs</a>';
/////////////
...
switch ($action)
{
 case 'del_job':
  ...
  $contents[] = array('align' => 'center', 'text' => '<br><a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_INDEED_JOBS, tep_get_all_get_params(array('page','action','selected_box'))).'&action=confirm_delete' . '">'.tep_button('Confirm','class="btn btn-delete"').'</a>&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_INDEED_JOBS, tep_get_all_get_params(array('action','selected_box'))) . '">' .tep_button('Cancel','class="btn btn-cancel"') . '</a>');
 ...
 default:
  if (is_object($jInfo))
  {
   ...
   $contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(FILENAME_RECRUITER_POST_JOB, 'rID=' . $jInfo->rec_id .'&jobID=' . $jInfo->job_id ) . '">' . tep_button('Edit','class="btn btn-secondary"') . '</a> <a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_INDEED_JOBS, tep_get_all_get_params(array('jobID','selected_box'))).'&jobID='.$jInfo->job_id.'&action=del_job' . '">' . tep_button('Delete','class="btn btn-delete"') . '</a><br>&nbsp;');
  }
}
////
...
if($action1=='delete')
{
 ...
 $check_link='<br>'.TEXT_DELETE_WARNING.'<br><br><a href="#"  style="color:#ffffff" onclick="DeleteSelected(\''.$delete_action.'\')" class="btn btn-primary">Confirm</a>&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_INDEED_JOBS).'">' . tep_button('Cancel','class="btn btn-primary"') . '</a>';
