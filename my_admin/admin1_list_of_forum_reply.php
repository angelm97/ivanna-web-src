...
if($action=='update' ||$action=='edit')
{
 ...
 $feed_button   = '<a href="'.FILENAME_ADMIN1_LIST_OF_FORUM_REPLY.'">'.tep_button('Cancel','class="btn btn-primary"').'</a> <button class="btn btn-primary" type="submit">Update</button>';
 }
 ...
 $template->assign_vars(array(
  ...
  'TEXT_INFO_REPLY_DESCRIPTION1'=> tep_draw_textarea_field('description1', 'soft', '100', '20', stripslashes($description), '', '', true),
...
else
{
 ...
 switch ($action)
 {
  case 'delete':
   ...
   $contents[] = array('align' => 'center', 'text' => '<br><a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_LIST_OF_FORUM_REPLY, 'page=' . $_GET['page'] . '&rID=' . $_GET['rID'].'&action=confirm_delete'.$query_string) . '">'.tep_button('Confirm','class="btn btn-primary"').'</a>&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_LIST_OF_FORUM_REPLY, 'page=' . $_GET['page'] . '&rID=' . $_GET['rID'].$query_string) . '">' . tep_button('Cancel','class="btn btn-primary"') . '</a>');
  ...
  default:
   if (isset($fInfo) && is_object($fInfo))
   {
    ...
    $contents[] = array('align' => 'center', 'text' => '<br><a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_LIST_OF_FORUM_REPLY, 'page=' . $_GET['page'] .'&rID=' . $fInfo->id .'&action=edit'.$query_string) . '">'.tep_button('Edit','class="btn btn-primary"').'</a>&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_LIST_OF_FORUM_REPLY, 'page=' . $_GET['page'] .'&rID=' . $fInfo->id. '&action=delete'.$query_string) . '">'.tep_button('Delete','class="btn btn-primary"').'</a>');
 ...
 else
 {
  ...
  $template->assign_vars(array(
   ...
   'INFO_TEXT_SEARCH_POST1'=>tep_draw_input_field('search_post',$search_post,'size="5"'),
