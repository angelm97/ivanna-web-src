...
$template->assign_vars(array(
 ...
 'INFO_TEXT_FACEBOOK_FOOTER_LINK1' => tep_draw_input_field('facebook_footer_link',$facebook_footer_link,'size="40"'),
 'INFO_TEXT_LINKEDIN_FOOTER_LINK' => INFO_TEXT_LINKEDIN_FOOTER_LINK,
 'INFO_TEXT_LINKEDIN_FOOTER_LINK1' => tep_draw_input_field('linkedin_footer_link',$linkedin_footer_link,'size="40"'),
 'INFO_TEXT_TWITTER_FOOTER_LINK' => INFO_TEXT_TWITTER_FOOTER_LINK,
 'INFO_TEXT_TWITTER_FOOTER_LINK1' => tep_draw_input_field('twitter_footer_link',$twitter_footer_link,'size="40"'),
 'INFO_TEXT_GOOGLEPLUS_FOOTER_LINK' => INFO_TEXT_GOOGLEPLUS_FOOTER_LINK,
 'INFO_TEXT_GOOGLEPLUS_FOOTER_LINK1' => tep_draw_input_field('googleplus_footer_link',$googleplus_footer_link,'size="40"'),
