...
$template->assign_vars(array(
 ...
 'INFO_TEXT_FACEBOOK_PLUGIN1'       => tep_draw_pull_down_menu('facebook_plugin_status', $facebook_status_array, $facebook_plugin_status,''),
 'INFO_TEXT_FACEBOOK_PLUGIN_KEY'    => INFO_TEXT_FACEBOOK_PLUGIN_KEY,
 'INFO_TEXT_FACEBOOK_PLUGIN_KEY1'   => tep_draw_input_field('facebook_app_key',$facebook_app_key,'size="40"'),
 'INFO_TEXT_FACEBOOK_PLUGIN_SECRET' => INFO_TEXT_FACEBOOK_PLUGIN_SECRET,
 'INFO_TEXT_FACEBOOK_PLUGIN_SECRET1'=> tep_draw_input_field('facebook_app_secret',$facebook_app_secret,'size="60"'),
 ...
 'INFO_TEXT_FACEBOOK_PAGE1'      => tep_draw_input_field('facebook_page',$facebook_page,'size="60" onchange="checkPageLink()"'),
