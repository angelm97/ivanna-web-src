...
$template->assign_vars(array(
 ...
 'logo_image'=>'<img src="'.HOST_NAME.PATH_TO_IMG.DEFAULT_SITE_LOGO.'" style="width: 95px;">',
 'TEXT_INFO_EMAIL_ADDRESS1'=>tep_draw_input_field('TREF_email_address',$_POST['TREF_email_address']),
 'new_button'=>'<button type="button" class="btn btn-primary" onclick="location.href=\''.tep_href_link(PATH_TO_ADMIN).'\'">Cancel</button>&nbsp;<button type="submit" class="btn btn-primary">Submit</button>',
