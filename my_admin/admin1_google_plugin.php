...
$template->assign_vars(array(
 ...
 'INFO_TEXT_GOOGLE_PLUGIN1'       => tep_draw_pull_down_menu('google_plugin_status', $google_status_array, $google_submitter_status,''),
 'INFO_TEXT_GOOGLE_PLUGIN_KEY'    => INFO_TEXT_GOOGLE_PLUGIN_KEY,
 'INFO_TEXT_GOOGLE_PLUGIN_KEY1'   => tep_draw_input_field('google_app_key',$google_app_key,'size="40"'),
 'INFO_TEXT_GOOGLE_PLUGIN_SECRET' => INFO_TEXT_GOOGLE_PLUGIN_SECRET,
 'INFO_TEXT_GOOGLE_PLUGIN_SECRET1'=> tep_draw_input_field('google_app_secret',$google_app_secret,'size="60"'),
