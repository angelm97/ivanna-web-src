...
if (is_object($aInfo))
{
 ...
 $heading[] = array('params'=>'background="img/emp_left_bar_bg.gif"','text' => '<div class="list-group"><div class="list-group-item list-group-item-action info-bg font-weight-bold">' . tep_db_output($aInfo->full_name) . '</div></div>');
 $contents[] = array('align' => 'left','params'=>'class="dataTableRightRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"',  'text' =>'<a class="list-group-item list-group-item-action px-3 py-2" href="'.tep_href_link(FILENAME_JOBSEEKER_VIEW_RESUME,'query_string='.$query_string2.(tep_not_null($search_id)?"&search_id=".$search_id:"")).'" class="style27" target="_blank">'.IMAGE_PROFILE.'</a>');
 ...
 $contents[] = array('align' => 'left','params'=>'class="dataTableRightRow1" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"',  'text' =>'<a class="list-group-item list-group-item-action px-3 py-2" href="'.tep_href_link(FILENAME_RECRUITER_LIST_OF_APPLICATIONS,'query_string='.$query_string.'&query_string2='.$query_string3.(tep_not_null($search_id)?"&search_id=".$search_id:"")).'" class="style27">'.IMAGE_CHANGE_STATUS.'</a>');
 ...
 $contents[] = array('align' => 'left','params'=>'class="dataTableRightRow1" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"', 'text'  => '<a class="list-group-item list-group-item-action px-3 py-2" href="'.tep_href_link(FILENAME_EMPLOYER_INTERACTION,"query_string=".$query_string.(tep_not_null($search_id)?"&search_id=".$search_id:"")).'" class="style27">'.IMAGE_CONTACT.'</a>');
...
$template->assign_vars(array(
  ...
  'INFO_TEXT_SEARCH_APPLICANT'=>'<a class="list-group-item list-group-item-action px-3 py-2" href="'.tep_href_link(FILENAME_RECRUITER_SEARCH_APPLICANT).'" >'.INFO_TEXT_SEARCH_APPLICANT.'</a>',
...
if($mail_id > 0 && $action=='fead_back')
{
 ...
 $template->assign_vars(array(
  ...
  'INFO_TEXT_BACK'    => '<a class="btn btn-sm btn-secondary" href="'.tep_href_link(FILENAME_EMPLOYER_INTERACTION,"query_string=".$query_string).'">'.IMAGE_BACK.'</a>',
...
elseif($action=='preview')
{
 ...
 $template->assign_vars(array(
  ...
  'buttons'=>'<a href="#" onclick="javascript: set_action(\'back\');"><button class="btn btn-secondary">Back</button></a>&nbsp;&nbsp;'.tep_draw_submit_button_field('send_mail','Send Mail','class="btn btn-primary"'),
...
else
{
 ...
 if($view=='inbox')
 {
   $show='<a href="'.tep_href_link(FILENAME_EMPLOYER_INTERACTION,'query_string='.$query_string).'">Compose</a> | <a href="'.tep_href_link(FILENAME_RECRUITER_ATS_MAILS,'query_string='.$query_string).'">Todos los correo electoricos de los solicitantes</a>';
 ...
 {
   $show='<a href="'.tep_href_link(FILENAME_EMPLOYER_INTERACTION,'view=inbox&query_string='.$query_string).'">Mensajes</a> | <a href="'.tep_href_link(FILENAME_RECRUITER_ATS_MAILS,'query_string='.$query_string).'">Todos los correo electoricos de los solicitantes</a>';
