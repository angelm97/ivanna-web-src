...
function tep_update_whos_online() 
{
 ...
 if ($row = getAnyTableWhereData(WHOS_ONLINE_TABLE, "session_id = '" . tep_db_input($session_id) ."'","ip_address, time_last_click,session_id")) 
 {
  ...
  {
   tep_mail(SITE_OWNER, ADMIN_EMAIL, "Hacking attempt", "Site name : ejobsitesoftware.com/ejobsite<br>Hacking by the IP-Address: ".$ip_address, SITE_OWNER, ADMIN_EMAIL);
   session_unset();
