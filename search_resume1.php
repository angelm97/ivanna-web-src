    ...
    while($row = tep_db_fetch_array($result))
    {
     ...
     $template->assign_block_vars('search_resume_result', array(
      ...
      'category' => tep_db_output($job_category),
					 ...
					 'view'     => '<a target="_blank" href="'.tep_href_link(FILENAME_RECRUITER_RATES).'" class="text-primary">'.INFO_TEXT_VIEW.'</a>',
...
//   'button'                  => tep_image_submit(PATH_TO_BUTTON.'button_search.gif', IMAGE_SEARCH),
  'button'                  => tep_draw_submit_button_field('','Buscar','class="btn btn-primary"'),
...
//   'INFO_TEXT_KEYWORD3'      => INFO_TEXT_KEYWORD_CRITERIA.tep_draw_radio_field('word1', 'Yes', 'Yes', $word1,'id=radio_word1').'<label for="radio_word1">'.INFO_TEXT_KEYWORD_WORD1.'</label>'.tep_draw_radio_field('word1', 'No', '', $word1,'id=radio_word2').'<label for="radio_word2">'.INFO_TEXT_KEYWORD_WORD2.'</label>',
  'INFO_TEXT_KEYWORD3'      => '<small class="mr-1">'.INFO_TEXT_KEYWORD_CRITERIA.'</small>'.tep_draw_radio_field('word1', 'Yes', 'Yes', $word1,'id=radio_word1').'<label for="radio_word1">'.INFO_TEXT_KEYWORD_WORD1.'</label>'.tep_draw_radio_field('word1', 'No', '', $word1,'id=radio_word2').'<label for="radio_word2">'.INFO_TEXT_KEYWORD_WORD2.'</label>',
