...
{
 $template->assign_vars(array(
   'sort_jobfair'=>tep_draw_pull_down_menu('sort', $jobfair_view_array, $_GET['sort'],'onchange="document.form1.submit();" class="form-control form-control-sm float-left display-inline"'),
